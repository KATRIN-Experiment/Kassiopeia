...
namespace Kassiopeia
{
    ...
    class KSCyclicIterator
    {
        public:
            ...
            Bool_t operator++(); // cyclically increments the current iterator position, returning false if it hits the marked position
            Bool_t operator--(); // cyclically decrements the current iterator position, returning false if it hits the marked position
