...
namespace Kassiopeia
{
    ...
    {
        public:
            KSMultiplyExpression( const XType& anOperand, const double& aFactor ) :
                fOperand( anOperand ),
                fFactor( aFactor )
            {
            }
    ...
    template< class XType >
    KSMultiplyExpression< XType > operator*( const XType& anOperand, const double& aFactor )
    {
        return KSMultiplyExpression< XType >( anOperand, aFactor );
    }
    template< class XType >
    KSMultiplyExpression< XType > operator*( const double& aFactor, const XType& anOperand )
    {
        return KSMultiplyExpression< XType >( anOperand, aFactor );
    }
    ...
    {
        public:
            KSDivideExpression( const XType& anOperand, const double& aFactor ) :
                fOperand( anOperand ),
                fFactor( aFactor )
            {
            }
    ...
    template< class XType >
    KSDivideExpression< XType > operator/( const XType& anOperand, const double& aFactor )
    {
