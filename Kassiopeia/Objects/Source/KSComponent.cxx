...
void KSComponent::Initialize()
{
    ...
    if (fState != eInitialized) {
        objctmsg(eError) << "tried to initialize component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
    }
...
void KSComponent::Deinitialize()
{
    ...
    if (fState != eIdle) {
        objctmsg(eError) << "tried to deinitialize component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
    }
...
void KSComponent::Activate()
{
    ...
    if (fState != eActivated) {
        objctmsg(eError) << "tried to activate component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
    }
...
void KSComponent::Deactivate()
{
    ...
    if (fState != eInitialized) {
        objctmsg(eError) << "tried to deactivate component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
    }
...
void KSComponent::PushUpdate()
{
    ...
    if (fState != eUpdated) {
        objctmsg(eError) << "tried to push update component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
    }
...
void KSComponent::PushDeupdate()
{
    ...
    if (fState != eActivated) {
        objctmsg(eError) << "tried to push deupdate component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
    }
...
void KSComponent::PullUpdate()
{
    ...
    if (fState != eUpdated) {
        objctmsg(eError) << "tried to pull update component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
        return;
    }
...
void KSComponent::PullDeupdate()
{
    ...
    if (fState != eActivated) {
        objctmsg(eError) << "tried to pull deupdate component <" << this->GetName() << "> from state <" << this->fState
                         << ">" << eom;
        return;
    }
