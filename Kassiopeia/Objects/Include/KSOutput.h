...
namespace Kassiopeia
{
    ...
    template< class XParentType, class XMemberType >
    class KSOutput;

    template< class XParentType, class XMemberType >
    class KSOutputFactoryTemplate;
    ...
    class KSOutput< XParentType, const XChildType& (XParentType::*)( void ) const > :
        public KSObject
    {
        public:
            KSOutput( KSObject* aParentObject, XParentType* aParentPointer, const XChildType& (XParentType::*aMember)( void ) const ) :
                    KSObject(),
                    fState( sActivated ),
        ...
        public:
            ...
            KSObject* Output( const std::string& aLabel )
            {
                ...
                if( tChild == NULL )
                {
                    objctmsg( eError ) << "const-reference output <" << this->GetName() << "> has no output named <" << aLabel << ">" << eom;
                }
                else
                {
            ...
            void Initialize()
            {
                ...
                {
                    objctmsg( eError ) << "tried to initialize const-reference output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
            ...
            void Deinitialize()
            {
                if( fParentObject->State() != sInitialized )
                {
                    objctmsg( eError ) << "tried to deinitialize const-reference output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
            ...
            void Activate()
            {
                ...
                {
                    objctmsg( eError ) << "tried to activate const-reference output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
            ...
            void Deactivate()
            {
                if( fParentObject->State() != sActivated )
                {
                    objctmsg( eError ) << "tried to deactivate const-reference output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
    ...
    template< class XParentType, class XChildType >
    class KSOutputFactoryTemplate< XParentType, const XChildType& (XParentType::*)() const > :
        public KSOutputFactory
    {
        public:
            KSOutputFactoryTemplate( const XChildType& (XParentType::*aMember)() const ) :
                    fMember( aMember )
            {
            }
        ...
        public:
            KSObject* CreateOutput( KSObject* aParent ) const
            {
                ...
                if( tParent == NULL )
                {
                    objctmsg_debug( "output parent <" << aParent->GetName() << "> could not be cast to type <" << typeid( XParentType ).name() << ">" << eom );
                    return NULL;
                }
    ...
    template< class XParentType, class XChildType >
    class KSOutput< XParentType, XChildType (XParentType::*)( void ) const > :
        public KSObject
    {
        public:
        ...
        public:
            ...
            KSObject* Output( const std::string& aLabel )
            {
                ...
                if( tChild == NULL )
                {
                    objctmsg( eError ) << "copy-value output <" << this->GetName() << "> has no output named <" << aLabel << ">" << eom;
            ...
            void Initialize()
            {
                if( fParentObject->State() != sInitialized )
                {
                    objctmsg( eError ) << "tried to initialize copy-value output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
            ...
            void Deinitialize()
            {
                ...
                {
                    objctmsg( eError ) << "tried to deinitialize copy-value output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
            ...
            void Activate()
            {
                if( fParentObject->State() != sActivated )
                {
                    objctmsg( eError ) << "tried to activate copy-value output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
            ...
            void Deactivate()
            {
                if( fParentObject->State() != sInitialized )
                {
                    objctmsg( eError ) << "tried to deactivate copy-value output <" << this->GetName() << "> from state <" << this->State() << ">" << eom;
    ...
    template< class XParentType, class XChildType >
    class KSOutputFactoryTemplate< XParentType, XChildType (XParentType::*)() const > :
        public KSOutputFactory
    {
        public:
            KSOutputFactoryTemplate( XChildType (XParentType::*aMember)() const ) :
                    fMember( aMember )
            {
            }
            virtual ~KSOutputFactoryTemplate()
    ...
    int KSDictionary< XType >::AddOutput( XMemberType aMember, const std::string& aLabel )
    {
        ...
        KSOutputFactoryTemplate< XType, XMemberType >* tOutputMemberFactory = new KSOutputFactoryTemplate< XType, XMemberType >( aMember );
...
namespace katrin
{
    ...
    template< >
    inline bool KSOutputBuilder::Begin()
    {
    ...
    template< >
    inline bool KSOutputBuilder::AddAttribute( KContainer* aContainer )
    {
    ...
    template< >
    inline bool KSOutputBuilder::End()
    {
