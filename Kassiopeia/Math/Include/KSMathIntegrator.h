...
{
template<class XType> class KSMathIntegrator;
...
class KSMathIntegrator<KSMathSystem<XValueType, XDerivativeType, XErrorType>>
{
  ...
  public:
    virtual void Integrate(double aTime,
                           ...
                           const XValueType& anInitialValue, const double& aStep, XValueType& aFinalValue,
    ...
    virtual bool GetInitialDerivative(XDerivativeType& /*derv*/) const
    {
        return false;
    };

    //returns true if information valid
    virtual bool GetFinalDerivative(XDerivativeType& /*derv*/) const
    {
        return false;
    };
    ...
    virtual bool HasDenseOutput() const
    {
        return false;
    };
