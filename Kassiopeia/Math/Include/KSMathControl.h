...
template<class XSystemType> class KSMathControl;
...
class KSMathControl<KSMathSystem<XValueType, XDerivativeType, XErrorType>>
{
  ...
  public:
    ...
    virtual void Check(const XValueType& anInitialValue, const XValueType& aFinalValue, const XErrorType& anError,
                       bool& aFlag) = 0;
};
