...
class KSVTKGeneratorPainter : public katrin::KVTKPainter
{
  ...
  protected:
    ...
    static double GetScalarValue(const katrin::KThreeVector& aVector, std::string aName);
    static double GetScalarValue(const katrin::KThreeMatrix& aTensor, std::string aName);
...
inline void KSVTKGeneratorPainter::AddColor(const katrin::KThreeVector& aColor)
{
