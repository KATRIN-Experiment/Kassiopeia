...
void KSRootTerminator::CalculateTermination(const KSParticle& anInitialParticle, bool& aFlag)
{
    ...
    try {
        ...
        throw KSTerminatorError().Nest(e) << "Failed to calculate termination.";
    }
    return;
}
void KSRootTerminator::ExecuteTermination(const KSParticle& anInitialParticle, KSParticle& aFinalParticle,
                                          KSParticleQueue& aParticleQueue) const
{
    ...
    try {
        ...
        throw KSTerminatorError().Nest(e) << "Failed to execute terminator <" << fTerminator->GetName() << ">.";
    }
    return;
}
...
STATICINT sKSRootTerminatorDict = KSDictionary<KSRootTerminator>::AddCommand(
    &KSRootTerminator::AddTerminator, &KSRootTerminator::RemoveTerminator, "add_terminator", "remove_terminator");
