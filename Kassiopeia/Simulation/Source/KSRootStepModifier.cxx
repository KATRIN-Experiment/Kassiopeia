...
KSRootStepModifier::~KSRootStepModifier() = default;
...
bool KSRootStepModifier::ExecutePreStepModification()
{
    ...
    *fModifierParticle = *fInitialParticle;
    ...
    if (fModifiers.End() == 0) {
        ...
        modmsg_debug("  modifier particle position: <" << fModifierParticle->GetPosition().X() << ", "
                                                       << fModifierParticle->GetPosition().Y() << ", "
                                                       << fModifierParticle->GetPosition().Z() << ">" << eom);
        modmsg_debug("  modifier particle momentum: <" << fModifierParticle->GetMomentum().X() << ", "
        ...
        modmsg_debug("  modifier particle electric field: <"
                     << fModifierParticle->GetElectricField().X() << "," << fModifierParticle->GetElectricField().Y()
                     << "," << fModifierParticle->GetElectricField().Z() << ">" << eom);
        modmsg_debug("  modifier particle magnetic field: <"
                     << fModifierParticle->GetMagneticField().X() << "," << fModifierParticle->GetMagneticField().Y()
                     << "," << fModifierParticle->GetMagneticField().Z() << ">" << eom);
        modmsg_debug("  modifier particle angle to magnetic field: <" << fModifierParticle->GetPolarAngleToB() << ">"
                                                                      << eom);
    ...
    modmsg_debug("  modifier particle space: <"
                 << (fModifierParticle->GetCurrentSpace() ? fModifierParticle->GetCurrentSpace()->GetName() : "") << ">"
                 << eom);
    modmsg_debug("  modifier particle surface: <"
                 << (fModifierParticle->GetCurrentSurface() ? fModifierParticle->GetCurrentSurface()->GetName() : "")
                 << ">" << eom);
    modmsg_debug("  modifier particle time: <" << fModifierParticle->GetTime() << ">" << eom);
    modmsg_debug("  modifier particle length: <" << fModifierParticle->GetLength() << ">" << eom);
    ...
    modmsg_debug("  modifier particle momentum: <" << fModifierParticle->GetMomentum().X() << ", "
                                                   ...
                                                   << fModifierParticle->GetMomentum().Z() << ">" << eom);
    modmsg_debug("  modifier particle kinetic energy: <" << fModifierParticle->GetKineticEnergy_eV() << ">" << eom);
    modmsg_debug("  modifier particle electric field: <" << fModifierParticle->GetElectricField().X() << ","
                                                         << fModifierParticle->GetElectricField().Y() << ","
                                                         << fModifierParticle->GetElectricField().Z() << ">" << eom);
    modmsg_debug("  modifier particle magnetic field: <" << fModifierParticle->GetMagneticField().X() << ","
...
bool KSRootStepModifier::ExecutePostStepModification()
{
    ...
    modmsg_debug("  final particle space: <"
                 << (fModifierParticle->GetCurrentSpace() ? fModifierParticle->GetCurrentSpace()->GetName() : "") << ">"
                 << eom);
    modmsg_debug("  final particle surface: <"
                 << (fModifierParticle->GetCurrentSurface() ? fModifierParticle->GetCurrentSurface()->GetName() : "")
                 << ">" << eom);
    ...
    modmsg_debug("  final particle position: <" << fModifierParticle->GetPosition().X() << ", "
                                                << fModifierParticle->GetPosition().Y() << ", "
                                                << fModifierParticle->GetPosition().Z() << ">" << eom);
    modmsg_debug("  final particle momentum: <" << fModifierParticle->GetMomentum().X() << ", "
                                                << fModifierParticle->GetMomentum().Y() << ", "
                                                << fModifierParticle->GetMomentum().Z() << ">" << eom);
    modmsg_debug("  final particle kinetic energy: <" << fModifierParticle->GetKineticEnergy_eV() << ">" << eom);
    modmsg_debug("  final particle electric field: <" << fModifierParticle->GetElectricField().X() << ","
                                                      << fModifierParticle->GetElectricField().Y() << ","
                                                      << fModifierParticle->GetElectricField().Z() << ">" << eom);
    modmsg_debug("  final particle magnetic field: <" << fModifierParticle->GetMagneticField().X() << ","
                                                      << fModifierParticle->GetMagneticField().Y() << ","
                                                      << fModifierParticle->GetMagneticField().Z() << ">" << eom);
