...
template<> inline bool KSIntDecayCalculatorDeathConstRateBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSIntDecayCalculatorDeathConstRateBuilder::AddElement(KContainer* aContainer)
{
