...
template<> inline bool KSIntDecayCalculatorFerencIonisationBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSIntDecayCalculatorFerencIonisationBuilder::AddElement(KContainer* aContainer)
{
