...
namespace katrin
{
    ...
    template< >
    inline bool KSIntDecayCalculatorGlukhovIonisationBuilder::AddAttribute( KContainer* aContainer )
    {
    ...
    template< >
    inline bool KSIntDecayCalculatorGlukhovIonisationBuilder::AddElement( KContainer* aContainer )
    {
