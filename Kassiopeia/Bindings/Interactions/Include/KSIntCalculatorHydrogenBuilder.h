...
class KSIntCalculatorHydrogenSet : public KSIntCalculatorSet
{
  public:
...
template<> inline bool KSIntCalculatorHydrogenSetBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSIntCalculatorHydrogenSetBuilder::End()
{
