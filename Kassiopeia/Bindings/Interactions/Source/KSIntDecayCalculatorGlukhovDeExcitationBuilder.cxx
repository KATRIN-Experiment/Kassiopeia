...
namespace katrin
{
    ...
    template< >
    KSIntDecayCalculatorGlukhovDeExcitationBuilder::~KComplexElement()
    {
    }
    ...
    STATICINT sToolboxKSIntDecayCalculatorGlukhovDeExcitation =
        KSRootBuilder::ComplexElement< KSIntDecayCalculatorGlukhovDeExcitation >( "ksint_decay_calculator_glukhov_deexcitation" );
}
