...
template<> inline bool KSGenDirectionSurfaceCompositeBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSGenDirectionSurfaceCompositeBuilder::AddElement(KContainer* aContainer)
{
