...
namespace katrin
{
    ...
    template< >
    inline bool KSGenDirectionSphericalCompositeBuilder::AddAttribute( KContainer* aContainer )
    {
    ...
    template< >
    inline bool KSGenDirectionSphericalCompositeBuilder::AddElement( KContainer* aContainer )
    {
