...
template<> inline bool KSGenPositionMaskBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSGenPositionMaskBuilder::AddElement(KContainer* aContainer)
{
