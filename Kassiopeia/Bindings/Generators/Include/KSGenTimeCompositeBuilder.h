...
template<> inline bool KSGenTimeCompositeBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSGenTimeCompositeBuilder::AddElement(KContainer* aContainer)
{
