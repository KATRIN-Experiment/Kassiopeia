...
template<> inline bool KSGenPositionFrustrumCompositeBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSGenPositionFrustrumCompositeBuilder::AddElement(KContainer* aContainer)
{
