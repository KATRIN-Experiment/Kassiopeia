...
template<> inline bool KSGenPositionRectangularCompositeBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSGenPositionRectangularCompositeBuilder::AddElement(KContainer* aContainer)
{
