...
namespace katrin
{
    ...
    template< >
    KSGenSpinCompositeBuilder::~KComplexElement()
    {
    }

    STATICINT sKSGenSpinCompositeStructure =
        KSGenSpinCompositeBuilder::Attribute< string >( "name" ) +
        KSGenSpinCompositeBuilder::Attribute< string >( "theta" ) +
        KSGenSpinCompositeBuilder::Attribute< string >( "phi" ) +
        KSGenSpinCompositeBuilder::Attribute< string >( "surface" ) +
    ...
    STATICINT sKSGenSpinComposite =
        KSRootBuilder::ComplexElement< KSGenSpinComposite >( "ksgen_spin_composite" );
