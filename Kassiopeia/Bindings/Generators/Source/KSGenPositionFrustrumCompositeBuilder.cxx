...
namespace katrin
{
    ...
    template< >
    KSGenPositionFrustrumCompositeBuilder::~KComplexElement()
    {
    }
    ...
    STATICINT sKSGenPositionFrustrumCompositeStructureROOT =
            ...
            KSGenPositionFrustrumCompositeBuilder::ComplexElement< KSGenValueHistogram >( "r_histogram" ) +KSGenPositionFrustrumCompositeBuilder::ComplexElement< KSGenValueFormula >( "phi_formula" ) +KSGenPositionFrustrumCompositeBuilder::ComplexElement< KSGenValueHistogram >( "phi_histogram" ) +
            KSGenPositionFrustrumCompositeBuilder::ComplexElement< KSGenValueFormula >( "z_formula" ) +KSGenPositionFrustrumCompositeBuilder::ComplexElement< KSGenValueHistogram >( "z_histogram" );
#endif
