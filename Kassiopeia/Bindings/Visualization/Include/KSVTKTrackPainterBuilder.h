...
template<> inline bool KSVTKTrackPainterBuilder::AddAttribute(KContainer* aContainer)
{
    ...
    if (aContainer->GetName() == "line_width") {
        aContainer->CopyTo(fObject, &KSVTKTrackPainter::SetLineWidth);
        return true;
    }
