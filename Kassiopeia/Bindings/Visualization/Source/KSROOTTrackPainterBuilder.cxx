...
STATICINT sKSROOTTrackPainterStructure =
    KSROOTTrackPainterBuilder::Attribute<string>("name") + KSROOTTrackPainterBuilder::Attribute<string>("path") +
    KSROOTTrackPainterBuilder::Attribute<string>("base") + KSROOTTrackPainterBuilder::Attribute<string>("x_axis") +
    ...
    KSROOTTrackPainterBuilder::Attribute<string>("color") + KSROOTTrackPainterBuilder::Attribute<string>("add_color") +
