...
namespace katrin
{
    ...
    template< >
    KSTrajTrajectoryAdiabaticSpinBuilder::~KComplexElement()
    {
    }
    ...
    STATICINT sKSTrajTrajectoryAdiabaticSpinStructure =
        ...
        KSTrajTrajectoryAdiabaticSpinBuilder::ComplexElement< KSTrajControlPositionNumericalError >( "control_position_error" ) +
        KSTrajTrajectoryAdiabaticSpinBuilder::ComplexElement< KSTrajControlMomentumNumericalError >( "control_momentum_error" ) +
