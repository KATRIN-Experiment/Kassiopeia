...
template<> inline bool KSTrajTrajectoryMagneticBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSTrajTrajectoryMagneticBuilder::AddElement(KContainer* aContainer)
{
