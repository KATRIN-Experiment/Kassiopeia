...
template<> inline bool KSTrajTrajectoryAdiabaticBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSTrajTrajectoryAdiabaticBuilder::AddElement(KContainer* aContainer)
{
