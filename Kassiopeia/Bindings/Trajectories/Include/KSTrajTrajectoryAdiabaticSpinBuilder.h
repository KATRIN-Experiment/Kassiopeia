...
namespace katrin
{
    ...
    template< >
    inline bool KSTrajTrajectoryAdiabaticSpinBuilder::AddAttribute( KContainer* aContainer )
    {
    ...
    template< >
    inline bool KSTrajTrajectoryAdiabaticSpinBuilder::AddElement( KContainer* aContainer )
    {
