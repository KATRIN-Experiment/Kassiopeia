...
namespace katrin
{
    ...
    template< >
    inline bool KSTrajTrajectoryElectricBuilder::AddAttribute( KContainer* aContainer )
    {
    ...
    template< >
    inline bool KSTrajTrajectoryElectricBuilder::AddElement( KContainer* aContainer )
    {
