...
template<> inline bool KSTrajTrajectoryExactTrappedBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSTrajTrajectoryExactTrappedBuilder::AddElement(KContainer* aContainer)
{
