...
template<> inline bool KSTrajTrajectoryExactSpinBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KSTrajTrajectoryExactSpinBuilder::AddElement(KContainer* aContainer)
{
