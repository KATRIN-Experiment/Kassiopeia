...
namespace katrin
{
    ...
    template< >
    KSComponentMaximumAtBuilder::~KComplexElement()
    {
    }

    STATICINT sKSComponentMaximumAtStructure =
        KSComponentMaximumAtBuilder::Attribute< string >( "name" ) +
        KSComponentMaximumAtBuilder::Attribute< string >( "group" ) +
        KSComponentMaximumAtBuilder::Attribute< string >( "component" ) +
        KSComponentMaximumAtBuilder::Attribute< string >( "parent" ) +
        KSComponentMaximumAtBuilder::Attribute< string >( "source" );
