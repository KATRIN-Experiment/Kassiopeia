...
template<> inline bool KSIntCalculatorHydrogenBuilder::Begin()
{
...
template<> inline bool KSIntCalculatorHydrogenBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> bool KSIntCalculatorHydrogenBuilder::End()
{
