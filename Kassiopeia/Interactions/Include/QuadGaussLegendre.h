...
namespace Kassiopeia {
    ...
    public:
        ...
        */
        ...
        static double Integrate32(XFunctorType &f, double a, double b, int n) {
            int j;
            double A, B, sum;
            ...
            static double x16[8] = {0.09501250983763744, 0.28160355077925891, 0.45801677765722739, 0.61787624440264375,
                                    0.75540440835500303, 0.86563120238783174, 0.94457502307323258, 0.98940093499164993};
            static double w16[8] = {0.189450610455068496, 0.182603415044923589, 0.169156519395002532,
                                    0.149595988816576731,
                                    0.124628971255533872, 0.095158511682492785, 0.062253523938647892,
                                    0.027152459411754095};
            static double x32[16] = {0.048307665687738316, 0.144471961582796493, 0.239287362252137075,
            ...
            static double w32[16] = {0.09654008851472780056, 0.09563872007927485942, 0.09384439908080456564,
        ...
        template<class XFunctorType>
        static double Integrate(XFunctorType &f, double a, double b, int n) {
