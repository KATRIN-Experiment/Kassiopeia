...
void KSIntSpinRotateYPulse::ExecuteInteraction(const KSParticle& anInteractionParticle, KSParticle& aFinalParticle,
                                               KSParticleQueue& /*aSecondaries*/) const
{
    ...
    aFinalParticle.SetSpinX(x * cos(katrin::KConst::Pi() / 180 * fAngle) +
                            z * sin(katrin::KConst::Pi() / 180 * fAngle));
    aFinalParticle.SetSpinZ(z * cos(katrin::KConst::Pi() / 180 * fAngle) -
                            x * sin(katrin::KConst::Pi() / 180 * fAngle));
