...
int main( int argc, char** argv )
{
    ...
    TH1D* transmission_histo = new TH1D("transmitted", "transmitted", tNumBinsTransmission+2, lower-tBinWidthTransmission, upper+tBinWidthTransmission);
    TH1D* produced_histo = new TH1D("produced", "produced", tNumBinsTransmission+2, lower-tBinWidthTransmission, upper+tBinWidthTransmission);
