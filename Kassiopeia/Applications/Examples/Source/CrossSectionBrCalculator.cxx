...
int main(int argc, char** argv)
{
    if (argc < 9) {
        cout
            ...
            << endl;
        // ./CrossSectionBrCalculator ~/Work/kasper/install/config/Kassiopeia/Examples/TestProject8Simulation.xml -1.0 1.0 -1.0 1.0 0.0 1000 field_electromagnet
...
//#endif
    ...
    TH2* h2 = new TH2D("h2", "Central Cross-Section B_r", n + 1, x_min, x_max, n + 1, y_min, y_max);
