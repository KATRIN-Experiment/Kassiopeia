...
void KSTrajTrajectoryMagnetic::CalculateTrajectory(const KSParticle& anInitialParticle, KSParticle& aFinalParticle,
...
void KSTrajTrajectoryMagnetic::GetPiecewiseLinearApproximation(
...
void KSTrajTrajectoryMagnetic::Differentiate(double aTime, const KSTrajMagneticParticle& aValue,
...
STATICINT sKSTrajTrajectoryMagneticDict =
    KSDictionary<KSTrajTrajectoryMagnetic>::AddCommand(&KSTrajTrajectoryMagnetic::SetIntegrator,
                                                       &KSTrajTrajectoryMagnetic::ClearIntegrator, "set_integrator",
                                                       "clear_integrator") +
    KSDictionary<KSTrajTrajectoryMagnetic>::AddCommand(&KSTrajTrajectoryMagnetic::SetInterpolator,
                                                       &KSTrajTrajectoryMagnetic::ClearInterpolator, "set_interpolator",
                                                       "clear_interpolator") +
    KSDictionary<KSTrajTrajectoryMagnetic>::AddCommand(
        &KSTrajTrajectoryMagnetic::AddTerm, &KSTrajTrajectoryMagnetic::RemoveTerm, "add_term", "remove_term") +
    KSDictionary<KSTrajTrajectoryMagnetic>::AddCommand(&KSTrajTrajectoryMagnetic::AddControl,
                                                       &KSTrajTrajectoryMagnetic::RemoveControl, "add_control",
                                                       "remove_control");
