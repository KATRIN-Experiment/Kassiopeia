...
namespace Kassiopeia
{
    ...
    void KSTrajControlMomentumNumericalError::Check( const KSTrajExactParticle& anInitialParticle, const KSTrajExactParticle& aFinalParticle, const KSTrajExactError& anError, bool& aFlag )
    {
    ...
    void KSTrajControlMomentumNumericalError::Check( const KSTrajAdiabaticParticle& anInitialParticle, const KSTrajAdiabaticParticle& aFinalParticle, const KSTrajAdiabaticError& anError, bool& aFlag )
    {
        fTimeStep = aFinalParticle.GetTime() - anInitialParticle.GetTime();
