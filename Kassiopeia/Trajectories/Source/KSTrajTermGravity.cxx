...
namespace Kassiopeia
{
    ...
    KSTrajTermGravity::KSTrajTermGravity() :
            fGravity( KThreeVector( 0., 0., 0. ) )
    {
    }
    KSTrajTermGravity::KSTrajTermGravity( const KSTrajTermGravity& aCopy ) :
        KSComponent(),
        fGravity( aCopy.fGravity )
    {
    }
    ...
    void KSTrajTermGravity::Differentiate(double /*aTime*/, const KSTrajExactParticle& aParticle, KSTrajExactDerivative& aDerivative ) const
    {
        aDerivative.AddToForce( fGravity * aParticle.GetMass() );
    }

    void KSTrajTermGravity::Differentiate(double /*aTime*/, const KSTrajExactSpinParticle& aParticle, KSTrajExactSpinDerivative& aDerivative ) const
    {
        aDerivative.AddToForce( fGravity * aParticle.GetMass() );
    }
    ...
    void KSTrajTermGravity::Differentiate(double /*aTime*/, const KSTrajAdiabaticSpinParticle& aParticle, KSTrajAdiabaticSpinDerivative& aDerivative ) const
    {
        aDerivative.AddToForce( fGravity * aParticle.GetMass() );
    }
