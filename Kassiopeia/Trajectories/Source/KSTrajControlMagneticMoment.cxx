...
namespace Kassiopeia
{
    ...
    void KSTrajControlMagneticMoment::Check( const KSTrajExactParticle& anInitialParticle, const KSTrajExactParticle& aFinalParticle, const KSTrajExactError&, bool& aFlag )
    {
        ...
        double tAdiabaticityViolation = fabs( 2. * (tFinalMagneticMoment - tInitialMagneticMoment) / (tFinalMagneticMoment + tInitialMagneticMoment) );

        fTimeStep = aFinalParticle.GetTime() - anInitialParticle.GetTime();

        if( tAdiabaticityViolation < fLowerLimit )
        {
            trajmsg_debug( "stepsize magnetic moment increasing stepsize at violation <" << tAdiabaticityViolation << ">" << eom) ;
        ...
        {
            trajmsg_debug( "stepsize magnetic moment decreasing stepsize at violation <" << tAdiabaticityViolation << ">" << eom );
    ...
    void KSTrajControlMagneticMoment::Check( const KSTrajExactSpinParticle& anInitialParticle, const KSTrajExactSpinParticle& aFinalParticle, const KSTrajExactSpinError&, bool& aFlag )
    {
        double tFinalMagneticMoment = aFinalParticle.GetOrbitalMagneticMoment();
        double tInitialMagneticMoment = anInitialParticle.GetOrbitalMagneticMoment();
        double tAdiabaticityViolation = fabs( 2. * (tFinalMagneticMoment - tInitialMagneticMoment) / (tFinalMagneticMoment + tInitialMagneticMoment) );
    ...
    void KSTrajControlMagneticMoment::Check( const KSTrajAdiabaticSpinParticle& anInitialParticle, const KSTrajAdiabaticSpinParticle& aFinalParticle, const KSTrajAdiabaticSpinError&, bool& aFlag )
    {
        double tFinalMagneticMoment = aFinalParticle.GetOrbitalMagneticMoment();
        double tInitialMagneticMoment = anInitialParticle.GetOrbitalMagneticMoment();
        double tAdiabaticityViolation = fabs( 2. * (tFinalMagneticMoment - tInitialMagneticMoment) / (tFinalMagneticMoment + tInitialMagneticMoment) );
    ...
    void KSTrajControlMagneticMoment::Check( const KSTrajAdiabaticParticle& anInitialParticle, const KSTrajAdiabaticParticle& aFinalParticle, const KSTrajAdiabaticError&, bool& aFlag )
    {
        double tFinalMagneticMoment = aFinalParticle.GetOrbitalMagneticMoment();
        double tInitialMagneticMoment = anInitialParticle.GetOrbitalMagneticMoment();
        double tAdiabaticityViolation = fabs( 2. * (tFinalMagneticMoment - tInitialMagneticMoment) / (tFinalMagneticMoment + tInitialMagneticMoment) );
