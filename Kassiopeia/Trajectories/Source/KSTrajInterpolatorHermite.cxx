                                            ...
                                            KSTrajExactParticle& anIntermediateParticle) const
{
    ...
    if (tFraction >= 0.0 && tFraction <= 1.0) {
        ...
        anIntermediateParticle = h30 * anInitialParticle + h31 * tDeltaTime * initialDerivative +
                                 h32 * tDeltaTime * finalDerivative + h33 * aFinalParticle;
        ...
        fFastInterpolator.Interpolate(aTime,
                                      anIntegrator,
                                      aDifferentiator,
                                      anInitialParticle,
                                      aFinalParticle,
...
void KSTrajInterpolatorHermite::Interpolate(double aTime, const KSTrajExactSpinIntegrator& anIntegrator,
...
void KSTrajInterpolatorHermite::Interpolate(double aTime, const KSTrajAdiabaticSpinIntegrator& anIntegrator,
...
void KSTrajInterpolatorHermite::Interpolate(double aTime, const KSTrajAdiabaticIntegrator& anIntegrator,
...
void KSTrajInterpolatorHermite::Interpolate(double aTime, const KSTrajMagneticIntegrator& anIntegrator,
...
void KSTrajInterpolatorHermite::Interpolate(double aTime, const KSTrajElectricIntegrator& anIntegrator,
...
double KSTrajInterpolatorHermite::DistanceMetric(const KSTrajExactParticle& valueA,
...
double KSTrajInterpolatorHermite::DistanceMetric(const KSTrajExactSpinParticle& valueA,
...
double KSTrajInterpolatorHermite::DistanceMetric(const KSTrajAdiabaticSpinParticle& valueA,
...
double KSTrajInterpolatorHermite::DistanceMetric(const KSTrajAdiabaticParticle& valueA,
...
double KSTrajInterpolatorHermite::DistanceMetric(const KSTrajMagneticParticle& valueA,
...
double KSTrajInterpolatorHermite::DistanceMetric(const KSTrajElectricParticle& valueA,
...
void KSTrajInterpolatorHermite::CubicHermite(double t, double& h30, double& h31, double& h32, double& h33)
{
    double t2 = t * t;
    double t3 = t * t2;
...
void KSTrajInterpolatorHermite::QuinticHermite(double t, double& h50, double& h51, double& h52, double& h53,
                                               double& h54, double& h55)
{
    double t2 = t * t;
    double t3 = t * t2;
    double t4 = t * t3;
