...
KSTrajControlEnergy::KSTrajControlEnergy(const KSTrajControlEnergy& aCopy) :
    ...
    fStepRescale(aCopy.fStepRescale),
...
void KSTrajControlEnergy::Check(const KSTrajExactParticle& anInitialParticle, const KSTrajExactParticle& aFinalParticle,
                                const KSTrajExactError&, bool& aFlag)
{
    fTimeStep = aFinalParticle.GetTime() - anInitialParticle.GetTime();

    double tFinalEnergy =
        (aFinalParticle.GetKineticEnergy() + aFinalParticle.GetCharge() * aFinalParticle.GetElectricPotential());
    double tInitialEnergy = (anInitialParticle.GetKineticEnergy() +
                             anInitialParticle.GetCharge() * anInitialParticle.GetElectricPotential());
...
void KSTrajControlEnergy::Calculate(const KSTrajExactSpinParticle& /*aParticle*/, double& aValue)
{
    if ((fFirstStep == true) || (fTimeStep == 0.)) {
        trajmsg_debug("stepsize energy on first step" << eom);
        fTimeStep = fInitialStep;
...
void KSTrajControlEnergy::Check(const KSTrajExactSpinParticle& anInitialParticle,
                                const KSTrajExactSpinParticle& aFinalParticle, const KSTrajExactSpinError&, bool& aFlag)
{
    fTimeStep = aFinalParticle.GetTime() - anInitialParticle.GetTime();
...
void KSTrajControlEnergy::Calculate(const KSTrajAdiabaticSpinParticle& /*aParticle*/, double& aValue)
{
    if ((fFirstStep == true) || (fTimeStep == 0.)) {
        trajmsg_debug("stepsize energy on first step" << eom);
        fTimeStep = fInitialStep;
...
void KSTrajControlEnergy::Check(const KSTrajAdiabaticSpinParticle& anInitialParticle,
                                const KSTrajAdiabaticSpinParticle& aFinalParticle, const KSTrajAdiabaticSpinError&,
                                bool& aFlag)
{
    fTimeStep = aFinalParticle.GetTime() - anInitialParticle.GetTime();
...
void KSTrajControlEnergy::Check(const KSTrajAdiabaticParticle& anInitialParticle,
                                const KSTrajAdiabaticParticle& aFinalParticle, const KSTrajAdiabaticError&, bool& aFlag)
{
    fTimeStep = aFinalParticle.GetTime() - anInitialParticle.GetTime();
