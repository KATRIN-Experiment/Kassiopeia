...
bool KSModDynamicEnhancement::ExecutePostStepModification(KSParticle& anInitialParticle, KSParticle& aFinalParticle,
...
void KSModDynamicEnhancement::InitializeComponent()
{
    if (fScattering != nullptr && fReferenceCrossSectionEnergy != -1. && fDynamic) {
        ...
        fScattering->CalculateAverageCrossSection(*tInitialisationParticle,
                                                  *tInitialisationParticle,
                                                  fReferenceCrossSection);
        modmsg(eNormal) << "Initialisation: Dynamic Enhancement Reference CrossSection is: " << fReferenceCrossSection
                        << " at " << fReferenceCrossSectionEnergy << " eV" << eom;
