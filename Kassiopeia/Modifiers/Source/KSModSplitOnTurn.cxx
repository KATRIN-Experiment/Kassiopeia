...
bool KSModSplitOnTurn::ExecutePostStepModification(KSParticle& /*anInitialParticle*/, KSParticle& aFinalParticle,
                                                   KSParticleQueue& aQueue)
{
    ...
    if (DotProduct * fCurrentDotProduct < 0.) {
        if (((fDirection & eForward) && fCurrentDotProduct > 0.) ||
            ((fDirection & eBackward) && fCurrentDotProduct < 0.)) {
