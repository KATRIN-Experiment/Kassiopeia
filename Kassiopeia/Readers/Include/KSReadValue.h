...
using KSThreeVector = KSReadValue<katrin::KThreeVector>;
using KSTwoVector = KSReadValue<katrin::KTwoVector>;
using KSThreeMatrix = KSReadValue<katrin::KThreeMatrix>;
using KSTwoMatrix = KSReadValue<katrin::KTwoMatrix>;
