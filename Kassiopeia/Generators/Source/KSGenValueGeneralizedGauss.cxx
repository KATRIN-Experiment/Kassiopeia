...
namespace Kassiopeia
{
    ...
    void KSGenValueGeneralizedGauss::DiceValue( vector< double >& aDicedValues )
    {
        ...
        if ( fValueMin == fValueMax )
        {
            ...
            fSolver.Solve( KMathBracketingSolver::eBrent, this, &KSGenValueGeneralizedGauss::ValueFunction, tValueGauss, -1e20, 1e20, tValue );  // fake (-inf,inf) integration by using (-1e20,1e20)
        }
        else
        {
            ...
            fSolver.Solve( KMathBracketingSolver::eBrent, this, &KSGenValueGeneralizedGauss::ValueFunction, tValueGauss, fValueMin, fValueMax, tValue );
        }
