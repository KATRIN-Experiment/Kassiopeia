...
void KSGenPositionFrustrumComposite::ClearRValue(KSGenValue* anRValue)
{
    ...
    genmsg(eError) << "cannot clear r value <" << anRValue->GetName() << "> from composite position frustrum creator <"
                   << this->GetName() << ">" << eom;
    return;
}
...
void KSGenPositionFrustrumComposite::ClearPhiValue(KSGenValue* anPhiValue)
{
    ...
    genmsg(eError) << "cannot clear phi value <" << anPhiValue->GetName()
                   << "> from composite position frustrum creator <" << this->GetName() << ">" << eom;
    return;
}
...
void KSGenPositionFrustrumComposite::ClearZValue(KSGenValue* anZValue)
{
    ...
    genmsg(eError) << "cannot clear z value <" << anZValue->GetName() << "> from composite position frustrum creator <"
                   << this->GetName() << ">" << eom;
    return;
}
...
STATICINT sKSGenPositionFrustrumCompositeDict =
    ...
    //                                                               "set_z1", "set_z2" ) +
    KSDictionary<KSGenPositionFrustrumComposite>::AddCommand(
        &KSGenPositionFrustrumComposite::SetRValue, &KSGenPositionFrustrumComposite::ClearRValue, "set_r", "clear_r") +
    KSDictionary<KSGenPositionFrustrumComposite>::AddCommand(&KSGenPositionFrustrumComposite::SetPhiValue,
                                                             &KSGenPositionFrustrumComposite::ClearPhiValue, "set_phi",
                                                             "clear_phi") +
    KSDictionary<KSGenPositionFrustrumComposite>::AddCommand(
        &KSGenPositionFrustrumComposite::SetZValue, &KSGenPositionFrustrumComposite::ClearZValue, "set_z", "clear_z");
