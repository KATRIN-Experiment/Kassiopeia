...
scale3 = scale/.75;
  ...
  p15 = newp; Point(p15) = {x,  y,  z,  scale3} ;
  p16 = newp; Point(p16) = {x+r,y,  z,   scale3} ;
  p17 = newp; Point(p17) = {x,  y+r,z,   scale3} ;
  p18 = newp; Point(p18) = {x,  y,  z+r, scale3} ;
  p19 = newp; Point(p19) = {x-r,y,  z,   scale3} ;
  p20 = newp; Point(p20) = {x,  y-r,z,   scale3} ;
  p21 = newp; Point(p21) = {x,  y,  z-r, scale3} ;
