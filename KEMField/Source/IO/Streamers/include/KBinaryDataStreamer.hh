...
template<typename Type> struct KBinaryDataStreamerType
{
...
template<> struct KBinaryDataStreamerType<std::string>
{
...
typedef KGenScatterHierarchy<KEMField::FundamentalTypes, KBinaryDataStreamerType> KBinaryDataStreamerFundamentalTypes;
...
class KBinaryDataStreamer : public KBinaryDataStreamerFundamentalTypes
{
  ...
  protected:
    KBinaryDataStreamer& Self() override
    {
        return *this;
    }
