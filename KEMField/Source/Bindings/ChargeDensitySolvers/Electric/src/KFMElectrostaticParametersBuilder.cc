...
template< >
KFMElectrostaticParametersBuilder::~KComplexElement() {
}
...
STATICINT sKFMElectrostaticParametersStructure =
	...
	KFMElectrostaticParametersBuilder::
			Attribute< double >( "world_cube_center_x" ) +
	KFMElectrostaticParametersBuilder::
			Attribute< double >( "world_cube_center_y" ) +
	KFMElectrostaticParametersBuilder::
			Attribute< double >( "world_cube_center_z" ) +
	KFMElectrostaticParametersBuilder::
    ...
    KFMElectrostaticParametersBuilder::
            Attribute<unsigned int>("allowed_fraction") +
    KFMElectrostaticParametersBuilder::
