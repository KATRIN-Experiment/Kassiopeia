...
template< >
KRampedMagneticFieldBuilder::~KComplexElement()
{
}

STATICINT sKRampedMagneticFieldStructure =
    KRampedMagneticFieldBuilder::Attribute< string >( "name" ) +
...
STATICINT sKRampedMagneticField =
    KEMToolboxBuilder::ComplexElement< KRampedMagneticField >( "ramped_magnetic_field" );
