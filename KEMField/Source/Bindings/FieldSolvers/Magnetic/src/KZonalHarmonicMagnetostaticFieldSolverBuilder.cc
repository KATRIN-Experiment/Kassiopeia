...
template< >
KZonalHarmonicMagnetostaticFieldSolverBuilder::~KComplexElement()
{
}
...
KStaticElectromagnetFieldBuilder::ComplexElement< KZonalHarmonicMagnetostaticFieldSolver >( "zonal_harmonic_field_solver" );
} /* namespace katrin */
