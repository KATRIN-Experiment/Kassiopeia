...
public:
	...
	std::pair<KThreeVector,double>& GetQuad256ElectricFieldAndPotential() const { return fQuad256ElectricFieldAndPotential;}

	std::pair<KThreeVector,double>& GetAnaElectricFieldAndPotential() const { return fAnaElectricFieldAndPotential;}

	std::pair<KThreeVector,double>& GetQuad2ElectricFieldAndPotential() const { return fQuad2ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetQuad3ElectricFieldAndPotential() const { return fQuad3ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetQuad4ElectricFieldAndPotential() const { return fQuad4ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetQuad6ElectricFieldAndPotential() const { return fQuad6ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetQuad8ElectricFieldAndPotential() const { return fQuad8ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetQuad16ElectricFieldAndPotential() const { return fQuad16ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetQuad32ElectricFieldAndPotential() const { return fQuad32ElectricFieldAndPotential;}
