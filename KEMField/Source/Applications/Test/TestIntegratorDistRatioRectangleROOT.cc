...
public:
	...
	std::pair<KThreeVector,double>& GetCub9ElectricFieldAndPotential() const { return fCub9ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetCub12ElectricFieldAndPotential() const { return fCub12ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetCub17ElectricFieldAndPotential() const { return fCub17ElectricFieldAndPotential;}
	std::pair<KThreeVector,double>& GetCub20ElectricFieldAndPotential() const { return fCub20ElectricFieldAndPotential;}
...
private:
	...
	mutable std::pair<KThreeVector,double> fCub9ElectricFieldAndPotential;
	mutable std::pair<KThreeVector,double> fCub12ElectricFieldAndPotential;
	mutable std::pair<KThreeVector,double> fCub17ElectricFieldAndPotential;
	mutable std::pair<KThreeVector,double> fCub20ElectricFieldAndPotential;
...
//	double costheta, sintheta, phi;
	...
	std::pair<KThreeVector,double> valCub[7];
