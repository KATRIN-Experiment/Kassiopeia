...
#ifdef SEPARATECOMP
            valQuad256 = std::make_pair(fQuadIntegrator.ElectricField(itLine->GetShape(), fP),
                                        fQuadIntegrator.Potential(itLine->GetShape(), fP));
            valAna = std::make_pair(intOCLAna.ElectricField(itLine->GetShape(), fP),
                                    intOCLAna.Potential(itLine->GetShape(), fP));
            valNum = std::make_pair(intOCLNum.ElectricField(itLine->GetShape(), fP),
                                    intOCLNum.Potential(itLine->GetShape(), fP));
#else
