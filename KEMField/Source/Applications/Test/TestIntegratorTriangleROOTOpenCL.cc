...
#ifdef SEPARATECOMP
            valQuad = std::make_pair(fQuadIntegrator.ElectricField(itTri->GetShape(), fP),
                                     fQuadIntegrator.Potential(itTri->GetShape(), fP));
            valAna = std::make_pair(intOCLAna.ElectricField(itTri->GetShape(), fP),
                                    intOCLAna.Potential(itTri->GetShape(), fP));
            valNum = std::make_pair(intOCLNum.ElectricField(itTri->GetShape(), fP),
                                    intOCLNum.Potential(itTri->GetShape(), fP));
            valRwg = std::make_pair(intOCLRwg.ElectricField(itTri->GetShape(), fP),
                                    intOCLRwg.Potential(itTri->GetShape(), fP));
#else
