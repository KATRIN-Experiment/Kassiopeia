...
template<typename ValueType> class KSimpleSquareMatrix : public KSquareMatrix<ValueType>
{
  public:
...
template<typename ValueType> KSimpleSquareMatrix<ValueType>::KSimpleSquareMatrix(unsigned int size)
{
...
template<typename ValueType> unsigned int KSimpleSquareMatrix<ValueType>::Dimension() const
{
...
template<typename ValueType> ValueType& KSimpleSquareMatrix<ValueType>::operator()(unsigned int i, unsigned int j)
{
    return fElements.at(i).at(j);
}
