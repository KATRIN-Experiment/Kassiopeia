...
namespace KEMField
{
template<typename ValueType> class KMatrix
{
  public:
    KMatrix() : fRow(*this) {}
    virtual ~KMatrix() {}
...
template<typename ValueType> void KMatrix<ValueType>::Multiply(const KVector<ValueType>& x, KVector<ValueType>& y) const
{
...
void KMatrix<ValueType>::MultiplyTranspose(const KVector<ValueType>& x, KVector<ValueType>& y) const
{
