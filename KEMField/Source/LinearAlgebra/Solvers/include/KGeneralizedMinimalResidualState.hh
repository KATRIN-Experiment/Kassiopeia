...
template<typename ValueType> class KGeneralizedMinimalResidualState
{
  public:
    ...
    virtual void SetIterationCount(unsigned int j)
    {
        fJ = j;
    };
    virtual unsigned int GetIterationCount() const
    {
        return fJ;
    };

    virtual void SetResidualNorm(ValueType res)
    {
        fResidualNorm = res;
    };
    ...
    virtual const KSimpleVector<ValueType>* GetResidualVector() const
    {
        return &fR;
    };
    ...
    virtual const std::vector<KSimpleVector<ValueType>>* GetMinimizationMatrix() const
    {
        return &fH;
    };
    ...
    virtual const std::vector<KSimpleVector<ValueType>>* GetKrylovSpaceBasis() const
    {
        return &fV;
    };
    ...
    virtual const KSimpleVector<ValueType>* GetMinimizationRightHandSide() const
    {
        return &fP;
    };
    ...
    virtual const KSimpleVector<ValueType>* GetGivensRotationCosines() const
    {
        return &fC;
    };
    ...
    virtual const KSimpleVector<ValueType>* GetGivensRotationSines() const
    {
        return &fS;
    };
