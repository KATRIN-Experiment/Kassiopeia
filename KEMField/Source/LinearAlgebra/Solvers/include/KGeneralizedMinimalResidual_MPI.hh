...
template< typename ValueType >
void
KGeneralizedMinimalResidual_MPI<ValueType>::Initialize()
{
...
template< typename ValueType >
void
KGeneralizedMinimalResidual_MPI<ValueType>::ResetAndInitialize()
{
...
template< typename ValueType >
void
KGeneralizedMinimalResidual_MPI<ValueType>::AugmentKrylovSubspace()
{
    ...
    fH[fJ].resize(fJ+1); for(unsigned int n=0; n <= fJ; n++){fH[fJ][n] = 0;};
...
template< typename ValueType >
void
KGeneralizedMinimalResidual_MPI<ValueType>::UpdateSolution()
{
...
template< typename ValueType >
double
KGeneralizedMinimalResidual_MPI<ValueType>::InnerProduct(const Vector& a, const Vector& b)
{
    double result = 0.;
...
template <typename ValueType>
void
KGeneralizedMinimalResidual_MPI<ValueType>::SetResidualVector(const Vector& v)
{
...
template <typename ValueType>
void
KGeneralizedMinimalResidual_MPI<ValueType>::GetResidualVector(Vector& v) const
{
...
KGeneralizedMinimalResidual_MPI<ValueType>::GetState() const
{
...
template <typename ValueType>
void
KGeneralizedMinimalResidual_MPI<ValueType>::SetState(const KGeneralizedMinimalResidualState<ValueType>& state)
{
...
template <typename ValueType>
void
KGeneralizedMinimalResidual_MPI<ValueType>::ReconstructState()
{
