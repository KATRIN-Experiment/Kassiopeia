...
namespace KEMField
{
  ...
  public:
    ...
    static std::string Name() { return "Electromagnet"; }

    KEMCoordinateSystem& GetCoordinateSystem() { return fCoordinateSystem; }
  ...
  protected:
    ...
    friend Stream& operator>>(Stream& s,KElectromagnet& m)
    {
    ...
    template <typename Stream>
    friend Stream& operator<<(Stream& s,const KElectromagnet& m)
    {
