...
class KFMDenseBlockSparseMatrixStructureGenerator: public KFMNodeActor< KFMNode<ObjectTypeList> >
{
    public:
        ...
        const std::vector<size_t>* GetRowIndices() const {return &fRowIndices;}
        const std::vector<size_t>* GetColumnIndices() const {return &fColumnIndices;};
        const KFMDenseBlockSparseMatrixStructure* GetMatrixStructure() const {return &fMatrixStructure;};
                        ...
                        if(nrows != 0)
                        {
                            ...
                            if(ncols > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    fRowIndices.insert(fRowIndices.end(), fTempRowIndices.begin(), fTempRowIndices.end());
                                    fColumnIndices.insert(fColumnIndices.end(), fTempColIndices.begin(), fTempColIndices.end());
                                }
                            }
