...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    kfmout << "next biggest power of two after 187 is " << KFMBitReversalPermutation::NextLowestPowerOfTwo(187)
           << kfmendl;
    kfmout << "next biggest power of two after 2345 is " << KFMBitReversalPermutation::NextLowestPowerOfTwo(2345)
           << kfmendl;
    kfmout << "next biggest power of two after 78456 is " << KFMBitReversalPermutation::NextLowestPowerOfTwo(78456)
           << kfmendl;
