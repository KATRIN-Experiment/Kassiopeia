...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    KFMPoint<1> line_center;
    line_center[0] = 0;
    KFMPoint<2> square_center;
    square_center[0] = 0;
    square_center[1] = 0;
    KFMPoint<3> cube_center;
    cube_center[0] = 0;
    cube_center[1] = 0;
    cube_center[2] = 0;
    KFMPoint<4> hypercube_center;
    hypercube_center[0] = 0;
    hypercube_center[1] = 0;
    hypercube_center[2] = 0;
    hypercube_center[3] = 0;
    ...
    for (unsigned int i = 0; i < KFMArrayMath::PowerOfTwo<4>::value; i++) {
        ...
        std::cout << "hypercube corner @ " << i << " = (" << c[0] << ", " << c[1] << ", " << c[2] << ", " << c[3] << ")"
                  << std::endl;
    }
