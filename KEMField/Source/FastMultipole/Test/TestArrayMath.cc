...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    std::cout << "the test indexes = " << test_index[0] << ", " << test_index[1] << ", " << test_index[2] << ", "
              << test_index[3] << ", " << test_index[4] << std::endl;
    std::cout << "the indexes = " << index[0] << ", " << index[1] << ", " << index[2] << ", " << index[3] << ", "
              << index[4] << std::endl;
