...
template<typename ValueType> class KFMDenseBlockSparseBoundaryIntegralMatrix : public KSquareMatrix<ValueType>
{
  public:
  ...
  protected:
    void Initialize()
    {
        ...
        if (result) {
            ...
            delete structure_node;
            kfmout
                << "KFMDenseBlockSparseBoundaryIntegralMatrix::Initialize(): Error, structure file corrupt or not present."
                << kfmendl;
            kfmexit(1);
        }
        ...
        if (!row_exists) {
            ...
            kfmout << "KFMDenseBlockSparseBoundaryIntegralMatrix::Initialize(): Error, row file corrupt or not present."
                   << kfmendl;
        ...
        if (!col_exists) {
            ...
            delete fElementFileInterface;
            kfmout
                << "KFMDenseBlockSparseBoundaryIntegralMatrix::Initialize(): Error, column file corrupt or not present."
                << kfmendl;
        ...
        if (!elem_exists) {
            ...
            delete fElementFileInterface;
            kfmout
                << "KFMDenseBlockSparseBoundaryIntegralMatrix::Initialize(): Error, matrix element file corrupt or not present."
                << kfmendl;
