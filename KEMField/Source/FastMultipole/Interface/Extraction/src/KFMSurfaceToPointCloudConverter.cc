...
void
KFMSurfaceToPointCloudConverter::Visit(KTriangle& t)
{
...
void
KFMSurfaceToPointCloudConverter::Visit(KRectangle& r)
{
    ...
    KFMPoint<3> pp1; pp1[0] = p1[0]; pp1[1] = p1[1]; pp1[2] = p1[2];
    KFMPoint<3> pp2; pp2[0] = p2[0]; pp2[1] = p2[1]; pp2[2] = p2[2];
    KFMPoint<3> pp3; pp3[0] = p3[0]; pp3[1] = p3[1]; pp3[2] = p3[2];
...
void
KFMSurfaceToPointCloudConverter::Visit(KLineSegment& l)
{
