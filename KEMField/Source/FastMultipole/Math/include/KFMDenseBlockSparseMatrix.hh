  ...
  public:
    ...
    void Initialize()
    {
        ...
        if (result) {
            ...
            //error, abort
            delete structure_node;
            kfmout << "KFMDenseBlockSparseMatrix::Initialize(): Error, structure file" << fStructureFileName
        ...
        if (!elem_exists) {
            ...
            delete fColumnFileInterface;
            delete fElementFileInterface;
            kfmout << "KFMDenseBlockSparseMatrix::Initialize(): Error, matrix element file corrupt or not present."
                   << kfmendl;
