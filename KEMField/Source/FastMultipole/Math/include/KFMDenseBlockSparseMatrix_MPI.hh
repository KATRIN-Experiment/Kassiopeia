...
class KFMDenseBlockSparseMatrix_MPI: public KSquareMatrix< ValueType >
{
    public:
        ...
        static size_t GetSuggestedMaximumRowWidth() { return 2048;};

        std::string GetStructureMessage(){return fStructureMessage;};
        ...
        void Initialize()
        {
            ...
            else
            {
                //error, abort
                delete structure_node;
                kfmout<<"KFMDenseBlockSparseMatrix_MPI::Initialize(): Error, structure file: "<<fStructureFileName<<" corrupt or not present."<<kfmendl;
                kfmexit(1);
            }
            ...
            msg<<"********* Sparse matrix statistics from process #"<<KMPIInterface::GetInstance()->GetProcess()<<" *********"<<std::endl;
            msg<<"Sparse matrix component has "<<fMatrixStructure.GetNBlocks()<<" blocks. "<<std::endl;
            msg<<"Sparse matrix has "<<fMatrixStructure.GetNTotalNonZeroElements()<<" non-zero elements."<<std::endl;
            ...
            msg<<"Sparse matrix component is divided across "<<fMatrixStructure.GetNBuffers()<<" buffers. "<<std::endl;
            ...
            if(!col_exists)
            {
                ...
                delete fColumnFileInterface;
                delete fElementFileInterface;
                kfmout<<"KFMDenseBlockSparseMatrix_MPI::Initialize(): Error, column file corrupt or not present."<<kfmendl;
            ...
            if(!elem_exists)
            {
                ...
                delete fColumnFileInterface;
                delete fElementFileInterface;
                kfmout<<"KFMDenseBlockSparseMatrix_MPI::Initialize(): Error, matrix element file corrupt or not present."<<kfmendl;
