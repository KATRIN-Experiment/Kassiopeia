...
template<unsigned int NDIM> class KFMBoundaryCalculator
{
  public:
    KFMBoundaryCalculator() : fIsEmpty(true), fBallSupportSet(), fBoxSupportSet(), fCenter(){};
    ...
    {
        return fBallSupportSet.GetMinimalBoundingBall();
    };

    KFMBox<NDIM> GetMinimalBoundingBox() const
    {
        return fBoxSupportSet.GetMinimalBoundingBox();
    };
