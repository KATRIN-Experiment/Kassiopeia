...
KSmartPointer<FastMultipoleMatrix> KFastMultipoleMatrixGenerator::CreateMatrix(
				...
				KSmartPointer<FastMultipoleEBI> fm_integrator) const
{
	...
	KSmartPointer<FastMultipoleDenseMatrix> denseA(
			new FastMultipoleDenseMatrix(fm_integrator));
