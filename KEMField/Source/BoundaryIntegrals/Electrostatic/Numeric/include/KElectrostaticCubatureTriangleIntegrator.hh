...
static const double gTriCub7w[7] =
    {gTriCub7w3[0], gTriCub7w3[1], gTriCub7w3[1], gTriCub7w3[1], gTriCub7w3[2], gTriCub7w3[2], gTriCub7w3[2]};

// 12-point cubature

// barycentric (area) coordinates of the Gaussian points
static const double gTriCub12alpha[4] = {0.6238226509439084e-1,
                                         0.5522545665692000e-1,
                                         0.3432430294509488e-1,
                                         0.5158423343536001};
static const double gTriCub12beta[4] = {0.6751786707392436e-1,
                                        0.3215024938520156,
                                        0.6609491961867980,
                                        0.2777161669764050};
static const double gTriCub12gamma[4] = {0.8700998678316848,
                                         0.6232720494910644,
                                         0.3047265008681072,
                                         0.2064414986699949};
// Gaussian weights
static const double gTriCub12w4[4] = {0.2651702815743450e-1,
                                      0.4388140871444811e-1,
                                      0.2877504278497528e-1,
                                      0.6749318700980879e-1};
static const double gTriCub12w[12] = {gTriCub12w4[0] * 2.,
                                      gTriCub12w4[0] * 2.,
                                      gTriCub12w4[0] * 2.,
                                      gTriCub12w4[1] * 2.,
                                      gTriCub12w4[1] * 2.,
...
// barycentric (area) coordinates of the Gaussian points
static const double gTriCub16alpha[5] = {gTriCubCst0,
                                         0.081414823414554,
                                         0.658861384496480,
                                         0.898905543365938,
                                         0.008394777409958};
static const double gTriCub16beta[5] = {gTriCubCst0,
                                        0.459292588292723,
                                        0.170569307751760,
                                        0.050547228317031,
                                        0.263112829634638};
static const double gTriCub16gamma[5] = {gTriCubCst0,
                                         0.459292588292723,
                                         0.170569307751760,
                                         0.050547228317031,
                                         0.728492392955404};
// Gaussian weights
static const double gTriCub16w5[5] = {0.144315607677787,
                                      0.095091634267285,
                                      0.103217370534718,
                                      0.032458497623198,
                                      0.027230314174435};
...
// barycentric (area) coordinates of the Gaussian points
static const double gTriCub19alpha[6] = {gTriCubCst0,
                                         2.063496160252593e-2,
                                         1.258208170141290e-1,
                                         6.235929287619356e-1,
                                         9.105409732110941e-1,
                                         3.683841205473626e-2};
static const double gTriCub19beta[6] = {gTriCubCst0,
                                        4.896825191987370e-1,
                                        4.370895914929355e-1,
                                        1.882035356190322e-1,
                                        4.472951339445297e-2,
                                        7.411985987844980e-1};
...
// Gaussian weights
static const double gTriCub19w6[6] = {9.713579628279610e-2,
                                      9.400410068141950e-2 / 3.,
                                      2.334826230143263e-1 / 3.,
                                      2.389432167816273e-1 / 3.,
                                      7.673302697609430e-2 / 3.,
                                      2.597012362637364e-1 / 6.};
...
static const double gTriCub33alpha[8] = {4.570749859701478e-01,
...
static const double gTriCub33beta[8] = {2.714625070149261e-01,
...
static const double gTriCub33gamma[8] = {1. - gTriCub33alpha[0] - gTriCub33beta[0],
...
const double gTriCub33w8[8] = {6.254121319590276e-02,
                               4.991833492806094e-02,
                               2.426683808145203e-02,
                               2.848605206887754e-02,
                               7.931642509973638e-03,
                               4.322736365941421e-02,
                               2.178358503860756e-02,
                               1.508367757651144e-02};
static const double gTriCub33w[33] = {
    gTriCub33w8[0], gTriCub33w8[0], gTriCub33w8[0], gTriCub33w8[1], gTriCub33w8[1], gTriCub33w8[1], gTriCub33w8[2],
    gTriCub33w8[2], gTriCub33w8[2], gTriCub33w8[3], gTriCub33w8[3], gTriCub33w8[3], gTriCub33w8[4], gTriCub33w8[4],
    gTriCub33w8[4], gTriCub33w8[5], gTriCub33w8[5], gTriCub33w8[5], gTriCub33w8[5], gTriCub33w8[5], gTriCub33w8[5],
    gTriCub33w8[6], gTriCub33w8[6], gTriCub33w8[6], gTriCub33w8[6], gTriCub33w8[6], gTriCub33w8[6], gTriCub33w8[7],
    gTriCub33w8[7], gTriCub33w8[7], gTriCub33w8[7], gTriCub33w8[7], gTriCub33w8[7]};
