...
void KFMFastFourierTransformUtilities::ComputeTwiddleFactors(unsigned int N, std::complex<double>* twiddle)
{
...
void KFMFastFourierTransformUtilities::ComputeConjugateTwiddleFactors(unsigned int N,
...
void KFMFastFourierTransformUtilities::FFTRadixTwo_DIT(unsigned int N, std::complex<double>* data,
                                                       std::complex<double>* twiddle)
{
    FFTRadixTwo_DIT(N, (double*) &(data[0]), (double*) &(twiddle[0]));
}

void KFMFastFourierTransformUtilities::FFTRadixTwo_DIF(unsigned int N, std::complex<double>* data,
                                                       std::complex<double>* twiddle)
{
...
void KFMFastFourierTransformUtilities::FFTRadixTwo_DIT(unsigned int N, double* data, double* twiddle)
{
    //decimation in time
    ...
    if (KFMBitReversalPermutation::IsPowerOfTwo(N)) {
        ...
        kfmout << "KFMFastFourierTransformUtilities::FFTRadixTwo_DIT: error, array has length: " << N
               << " which is not an integer power of 2." << kfmendl;
    }
}


void KFMFastFourierTransformUtilities::FFTRadixTwo_DIF(unsigned int N, double* data, double* twiddle)
{
    ...
    if (KFMBitReversalPermutation::IsPowerOfTwo(N)) {
        ...
        kfmout << "KFMFastFourierTransformUtilities::FFTRadixTwo_DIF: error, array has length: " << N
               << " which is not an integer power of 2." << kfmendl;
    }
}
...
void KFMFastFourierTransformUtilities::ButterflyRadixThree(std::complex<double>& H0, std::complex<double>& H1,
                                                           std::complex<double>& H2, std::complex<double>& W0,
...
void KFMFastFourierTransformUtilities::FFTRadixThree(unsigned int N, std::complex<double>* data,
                                                     std::complex<double>* twiddle)
{
    ...
    if (KFMBitReversalPermutation::IsPowerOfBase(N, 3)) {
        ...
        kfmout << "KFMFastFourierTransformUtilities::FFTRadixThree: error, array has length: " << N
               << " which is not an integer power of 3." << kfmendl;
    }
}
...
unsigned int KFMFastFourierTransformUtilities::ComputeBluesteinArraySize(unsigned int N)
{
...
void KFMFastFourierTransformUtilities::ComputeBluesteinScaleFactors(unsigned int N, std::complex<double>* scale)
{
    //STEP A
...
void KFMFastFourierTransformUtilities::ComputeBluesteinCirculantVector(
...
void KFMFastFourierTransformUtilities::FFTBluestein(unsigned int N, unsigned int M,
