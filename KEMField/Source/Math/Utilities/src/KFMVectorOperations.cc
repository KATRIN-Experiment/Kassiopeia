...
void kfm_vector_set(const kfm_vector* src, kfm_vector* dest)
{
    if (src->size == dest->size) {
        ...
        kfmout << "kfm_vector_set: error, vectors have difference sizes: " << src->size << " != " << dest->size << "."
               << kfmendl;
        kfmexit(1);
    }
}
...
void kfm_vector_sub(kfm_vector* a, const kfm_vector* b)
{
    if (a->size == b->size) {
        ...
        kfmout << "kfm_vector_sub: error, vectors have difference sizes: " << a->size << " != " << b->size << "."
               << kfmendl;
        kfmexit(1);
    }
}
...
void kfm_vector_add(kfm_vector* a, const kfm_vector* b)
{
    if (a->size == b->size) {
        ...
        kfmout << "kfm_vector_add: error, vectors have difference sizes: " << a->size << " != " << b->size << "."
               << kfmendl;
        kfmexit(1);
    }
}
...
double kfm_vector_inner_product(const kfm_vector* a, const kfm_vector* b)
{
    ...
    if (a->size == b->size) {
        ...
        kfmout << "kfm_inner_product: error, vectors have difference sizes: " << a->size << " != " << b->size << "."
               << kfmendl;
        kfmexit(1);
    }
...
void kfm_vector_sub(const kfm_vector* a, const kfm_vector* b, kfm_vector* c)
{
    ...
    if ((a->size == b->size) && (b->size == c->size)) {
        ...
        kfmout << "kfm_inner_sub: error, vectors have difference sizes: " << a->size << " != " << b->size
               << " != " << c->size << "." << kfmendl;
        kfmexit(1);
    }
}
...
void kfm_vector_add(const kfm_vector* a, const kfm_vector* b, kfm_vector* c)
{
    if ((a->size == b->size) && (b->size == c->size)) {
        ...
        kfmout << "kfm_inner_add: error, vectors have difference sizes: " << a->size << " != " << b->size
               << " != " << c->size << "." << kfmendl;
        kfmexit(1);
    }
}
