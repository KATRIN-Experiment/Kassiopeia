...
class KFMFastFourierTransformUtilities
{
  public:
    ...
    ////////////////////////////////////////////////////////////////////////
    //RADIX-3
    static void ButterflyRadixThree(std::complex<double>& H0, std::complex<double>& H1, std::complex<double>& H2,
                                    std::complex<double>& W0, std::complex<double>& W1);
    ...
    static void ComputeBluesteinCirculantVector(unsigned int N, unsigned int M, std::complex<double>* twiddle,
                                                std::complex<double>* scale, std::complex<double>* circulant);

    //N is length of the data
    static void FFTBluestein(unsigned int N, unsigned int M, std::complex<double>* data, std::complex<double>* twiddle,
                             std::complex<double>* conj_twiddle, std::complex<double>* scale,
                             std::complex<double>* circulant, std::complex<double>* workspace);
