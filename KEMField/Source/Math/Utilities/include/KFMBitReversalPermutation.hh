...
class KFMBitReversalPermutation
{
  public:
    ...
    static void ComputeBitReversedIndicesBaseTwo(unsigned int N,
                                                 unsigned int* index_arr);  //must have N = 2^P, with P an integer
    ...
    template<typename DataType>
    static void PermuteArray(unsigned int N, unsigned int data_size, const unsigned int* permutation_index_arr,
                             DataType* arr)  //arbitrary data_size
    {
