...
namespace KEMField
{
    ...
    void kfm_matrix_multiply_with_transpose(bool transposeA, bool transposeB, const kfm_matrix* A, const kfm_matrix* B, kfm_matrix* C);
    ...
    void kfm_matrix_svd_solve(const kfm_matrix* U, const kfm_vector* S, const kfm_matrix* V, const kfm_vector* b, kfm_vector* x);
