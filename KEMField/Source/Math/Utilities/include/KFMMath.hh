...
class KFMMath
{
  public:
    ...
    static void SphericalHarmonic_Cart(int l, int m, const double* cartesian_coords, double* result);

    static void RegularSolidHarmonic_Cart(int l, int m, const double* cartesian_coords, double* result);

    static void IrregularSolidHarmonic_Cart(int l, int m, const double* cartesian_coords, double* result);

    static std::complex<double> SphericalHarmonic_Cart(int l, int m, const double* cartesian_coords);

    static std::complex<double> SphericalHarmonic_Sph(int l, int m, const double* spherical_coords);

    static std::complex<double> RegularSolidHarmonic_Cart(int l, int m, const double* cartesian_coords);

    static std::complex<double> IrregularSolidHarmonic_Cart(int l, int m, const double* cartesian_coords);


    ////////////////////////////////////////////////////////////////////////////////

    static void RegularSolidHarmonic_Cart_Array(int n_max, const double* cartesian_coords,
                                                std::complex<double>* result);

    static void IrregularSolidHarmonic_Cart_Array(int n_max, const double* cartesian_coords,
                                                  std::complex<double>* result);
