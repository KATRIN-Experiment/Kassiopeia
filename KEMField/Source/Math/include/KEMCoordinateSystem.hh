...
class KEMCoordinateSystem
{
  public:
    ...
    void SetXAxis(const KDirection& xAxis)
    {
        fXAxis = xAxis;
    }
    void SetYAxis(const KDirection& yAxis)
    {
        fYAxis = yAxis;
    }
    void SetZAxis(const KDirection& zAxis)
    {
        fZAxis = zAxis;
    }

    const KPosition& GetOrigin() const
    {
        return fOrigin;
    }
    const KDirection& GetXAxis() const
    {
        return fXAxis;
    }
    const KDirection& GetYAxis() const
    {
        return fYAxis;
    }
    const KDirection& GetZAxis() const
    {
        return fZAxis;
    }
...
template<typename Stream> Stream& operator>>(Stream& s, KEMCoordinateSystem& c)
{
...
template<typename Stream> Stream& operator<<(Stream& s, const KEMCoordinateSystem& c)
{
