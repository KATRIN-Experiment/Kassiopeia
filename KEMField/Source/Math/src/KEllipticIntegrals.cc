...
double KCompleteEllipticIntegral1stKind::operator()(double k) const
{
    ...
    static const double a[10] = {9.657359028085625e-2,
                                 3.088514627130518e-2,
                                 1.493801353268716e-2,
                                 8.789801874555064e-3,
                                 6.179627446053317e-3,
                                 6.847909282624505e-3,
                                 9.848929322176893e-3,
                                 8.003003980649985e-3,
                                 2.296634898396958e-3,
                                 1.393087857006646e-4};
    static const double b[10] = {1.249999999999080e-1,
                                 7.031249973903835e-2,
                                 4.882804190686239e-2,
                                 3.737773975862360e-2,
                                 3.012484901289893e-2,
                                 2.393191332311079e-2,
                                 1.553094163197720e-2,
                                 5.973904299155429e-3,
                                 9.215546349632498e-4,
                                 2.970028096655561e-5};
...
#else
    double eta = 1. - k * k;
    static const double c[10] = {4.431471805608895e-1,
                                 5.680519456755915e-2,
                                 2.183181167613048e-2,
                                 1.156959574529540e-2,
                                 7.595093422559432e-3,
                                 7.820404060959554e-3,
                                 1.077063503986645e-2,
                                 8.638442173604074e-3,
                                 2.468503330460722e-3,
                                 1.494662175718132e-4};
    static const double d[10] = {2.499999999999017e-1,
                                 9.374999972120314e-2,
                                 5.859366125553149e-2,
                                 4.271789054738309e-2,
                                 3.347894366576162e-2,
                                 2.614501470031387e-2,
                                 1.680402334636338e-2,
                                 6.432146586438301e-3,
                                 9.898332846225384e-4,
                                 3.185919565550157e-5};
...
double KEllipticCarlsonSymmetricRD::operator()(double x, double y, double z) const
{
    ...
    // z must be positive
    //  (see: Press et al., Numerical Recipes, Sec. 6.11).
    const double ERRTOL = 0.0015, C1 = 3. / 14., C2 = 1. / 6., C3 = 9. / 22., C4 = 3. / 26., C5 = 0.25 * C3,
                 C6 = 1.5 * C4;
...
double KEllipticCarlsonSymmetricRJ::operator()(double x, double y, double z, double p) const
{
    ...
    const double ERRTOL = 0.0015, C1 = 3. / 14., C2 = 1. / 3., C3 = 3. / 22., C4 = 3. / 26., C5 = 0.75 * C3,
                 C6 = 1.5 * C4, C7 = 0.5 * C2, C8 = 2. * C3;
    double a = 0., alamb, alpha, ans, ave, b = 0., beta, delp, delx, dely, delz, ea, eb, ec, ed, ee, fac, pt, rcx = 0.,
           rho, sum, sqrtx, sqrty, sqrtz, tau, xt, yt, zt;
    sum = 0.;
    fac = 1.;
    if (p > 0.) {
        xt = x;
