...
void KGaussLegendreQuadrature::operator()(double (*f)(double), double a, double b, unsigned int n, double* sum)
{
    ...
    static const double x16[8] = {0.09501250983763744,
                                  0.28160355077925891,
                                  0.45801677765722739,
                                  0.61787624440264375,
                                  0.75540440835500303,
                                  ...
                                  0.94457502307323258,
                                  0.98940093499164993};
    static const double w16[8] = {0.189450610455068496,
    ...
    static const double x32[16] = {0.048307665687738316,
    ...
    static const double w32[16] = {0.09654008851472780056,
