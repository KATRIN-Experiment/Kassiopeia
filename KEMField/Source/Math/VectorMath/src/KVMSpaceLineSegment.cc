...
void
KVMSpaceLineSegment::SetAll(const double* point1, const double* point2)
{
    SetPoint1(point1);
    SetPoint2(point2);
...
void
KVMSpaceLineSegment::SetVertices(const double* point1, const double* point2)
{
    SetAll(point1, point2);
}

void
KVMSpaceLineSegment::GetVertices( double* point1, double* point2) const
{
