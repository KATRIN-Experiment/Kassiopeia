...
int main(int /*argc*/, char** /*argv*/)
{
  ...
  if (testNumber == 0)
  {
    ...
    KEMField::cout<<"TEST: "<<lineCurrentIntegrator.MagneticField(lineCurrent,KPosition(dist,0.,0.))<<KEMField::endl;
  ...
  if (testNumber == 1)
  {
    ...
    KEMField::cout<<"TEST: "<<currentLoopIntegrator.MagneticField(currentLoop,KPosition(0.,0.,offset))<<KEMField::endl;
    KEMField::cout<<"should be "<<KEMConstants::Mu0*current*.5*(r*r/pow(offset*offset + r*r,1.5))<<KEMField::endl;
  }
  ...
  if (testNumber == 2)
  {
    ...
    KEMField::cout<<"CURRENT LOOP:  magnetic field at "<<P<<" is "<<currentLoopIntegrator.MagneticField(*currentLoop,P)<<KEMField::endl;
    KEMField::cout<<"CURRENT LOOP:  vector potential at "<<P<<" is "<<currentLoopIntegrator.VectorPotential(*currentLoop,P)<<KEMField::endl;

    KEMThreeVector B(0.,0.,0.);
    KEMThreeVector A(0.,0.,0.);
  ...
  if (testNumber == 3)
  {
    ...
    KEMField::cout<<"SOLENOID:  magnetic field at "<<P<<" is "<<solenoidIntegrator.MagneticField(*solenoid,P)<<KEMField::endl;
    KEMField::cout<<"SOLENOID:  vector potential at "<<P<<" is "<<solenoidIntegrator.VectorPotential(*solenoid,P)<<KEMField::endl;
  ...
  if (testNumber == 4)
  {
    ...
    KEMField::cout<<"COIL:  magnetic field at "<<P<<" is "<<coilIntegrator.MagneticField(*coil,P)<<KEMField::endl;
    KEMField::cout<<"COIL:  vector potential at "<<P<<" is "<<coilIntegrator.VectorPotential(*coil,P)<<KEMField::endl;
  ...
  if (testNumber == 7)
  {
    ...
    KEMField::cout<<"CURRENT LOOP:  magnetic field at "<<P<<" is "<<currentLoopFieldSolver.MagneticField(P)<<KEMField::endl;
    KEMField::cout<<"CURRENT LOOP:  vector potential at "<<P<<" is "<<currentLoopFieldSolver.VectorPotential(P)<<KEMField::endl;

    KEMField::cout<<"LINE CURRENTS:  magnetic field at "<<P<<" is "<<lineCurrentFieldSolver.MagneticField(P)<<KEMField::endl;
    KEMField::cout<<"LINE CURRENTS:  vector potential at "<<P<<" is "<<lineCurrentFieldSolver.VectorPotential(P)<<KEMField::endl;
  }
  ...
  if (testNumber == 8)
  {
    ...
    KEMField::cout<<"INTEGRATING:    magnetic field at "<<P<<" is "<<integratingFieldSolver.MagneticField(P)<<KEMField::endl;
    KEMField::cout<<"INTEGRATING:    vector potential at "<<P<<" is "<<integratingFieldSolver.VectorPotential(P)<<KEMField::endl;
    KEMField::cout<<"INTEGRATING:    magnetic field gradient at "<<P<<" is "<<integratingFieldSolver.MagneticFieldGradient(P)<<KEMField::endl;

    KEMField::cout<<"ZONAL HARMONIC: magnetic field at "<<P<<" is "<<zonalHarmonicFieldSolver.MagneticField(P)<<KEMField::endl;
    KEMField::cout<<"ZONAL HARMONIC: vector potential at "<<P<<" is "<<zonalHarmonicFieldSolver.VectorPotential(P)<<KEMField::endl;
    KEMField::cout<<"ZONAL HARMONIC: magnetic field gradient at "<<P<<" is "<<zonalHarmonicFieldSolver.MagneticFieldGradient(P)<<KEMField::endl;
  }
