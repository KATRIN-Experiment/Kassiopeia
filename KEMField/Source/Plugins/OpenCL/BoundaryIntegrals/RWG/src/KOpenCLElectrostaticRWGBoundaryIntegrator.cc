...
KElectrostaticBasis::ValueType KOpenCLElectrostaticRWGBoundaryIntegrator::BoundaryIntegral(KSurfacePrimitive* source,
...
KElectrostaticBasis::ValueType KOpenCLElectrostaticRWGBoundaryIntegrator::BoundaryValue(KSurfacePrimitive* surface,
                                                                                        unsigned int)
{
...
KElectrostaticBasis::ValueType& KOpenCLElectrostaticRWGBoundaryIntegrator::BasisValue(KSurfacePrimitive* surface,
                                                                                      unsigned int)
{
...
void KOpenCLElectrostaticRWGBoundaryIntegrator::ConstructOpenCLKernels() const
{
    ...
    clFile << KOpenCLInterface::GetInstance()->GetKernelPath()
           << "/kEMField_ElectrostaticRWGBoundaryIntegrals_kernel.cl";
