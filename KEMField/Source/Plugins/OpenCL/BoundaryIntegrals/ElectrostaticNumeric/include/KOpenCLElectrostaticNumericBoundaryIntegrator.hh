...
namespace KEMField
{
  ...
  template <class SourceShape>
  KThreeVector KOpenCLElectrostaticNumericBoundaryIntegrator::ElectricField(const SourceShape* source, const KPosition& aPosition) const
  {
    StreamSourceToBuffer(source);
  ...
  template <class SourceShape>
  std::pair<KThreeVector,double> KOpenCLElectrostaticNumericBoundaryIntegrator::ElectricFieldAndPotential(const SourceShape* source, const KPosition& aPosition) const
  {
	    StreamSourceToBuffer(source);
