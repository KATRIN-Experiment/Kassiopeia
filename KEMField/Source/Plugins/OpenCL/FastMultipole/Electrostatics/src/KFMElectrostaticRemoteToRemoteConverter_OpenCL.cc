...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::SetParameters(KFMElectrostaticParameters params)
{
    //set parameters
...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::SetTree(KFMElectrostaticTree* tree)
{
    fTree = tree;
...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::SetMultipoleNodeSet(
...
////////////////////////////////////////////////////////////////////////
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::Initialize()
{
...
////////////////////////////////////////////////////////////////////////
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::ApplyAction(KFMNode<KFMElectrostaticNodeObjects>* node)
{
            ...
            if (n_moment_sets != 0) {
                ...
                KOpenCLInterface::GetInstance()->GetQueue().enqueueWriteBuffer(
                    *fNodeIDBufferCL,
                    CL_TRUE,
                    0,
                    n_moment_sets * sizeof(unsigned int),
                    &(fCachedMultipoleNodeLists[special_id][0]));
                ...
                KOpenCLInterface::GetInstance()->GetQueue().enqueueWriteBuffer(
                    *fBlockSetIDListBufferCL,
                    ...
                    0,
                    n_moment_sets * sizeof(unsigned int),
                    &(fCachedBlockSetIDLists[special_id][0]));
...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::BuildBuffers()
{
    ...
    CL_ERROR_TRY
    {
        fChildMomentBufferCL = new cl::Buffer(KOpenCLInterface::GetInstance()->GetContext(),
                                              CL_MEM_READ_WRITE,
    ...
    CL_ERROR_TRY
    {
        fTransformedChildMomentBufferCL = new cl::Buffer(KOpenCLInterface::GetInstance()->GetContext(),
                                                         CL_MEM_READ_WRITE,
                                                         moment_buffer_size * sizeof(CL_TYPE2));
    }
    CL_ERROR_CATCH
...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::AssignBuffers()
{
...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::ConstructCopyAndScaleKernel()
{
    //Get name of kernel source file
    std::stringstream clFile;
    clFile << KOpenCLInterface::GetInstance()->GetKernelPath()
           << "/kEMField_KFMElectrostaticRemoteToRemoteCopyAndScale_kernel.cl";
...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::ConstructTransformationKernel()
{
    //Get name of kernel source file
    std::stringstream clFile;
    clFile << KOpenCLInterface::GetInstance()->GetKernelPath()
           << "/kEMField_KFMElectrostaticRemoteToRemoteTransformation_kernel.cl";
...
void KFMElectrostaticRemoteToRemoteConverter_OpenCL::ConstructReduceAndScaleKernel()
{
    //Get name of kernel source file
    std::stringstream clFile;
    clFile << KOpenCLInterface::GetInstance()->GetKernelPath()
           << "/kEMField_KFMElectrostaticRemoteToRemoteReduceAndScale_kernel.cl";

    KOpenCLKernelBuilder k_builder;
    fReduceAndScaleKernel =
        k_builder.BuildKernel(clFile.str(), std::string("ElectrostaticRemoteToRemoteReduceAndScale"));
