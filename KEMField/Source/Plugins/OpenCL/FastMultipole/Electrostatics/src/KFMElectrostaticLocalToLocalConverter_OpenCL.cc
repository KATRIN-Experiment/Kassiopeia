...
void KFMElectrostaticLocalToLocalConverter_OpenCL::SetTree(KFMElectrostaticTree* tree)
{
    fTree = tree;
...
void KFMElectrostaticLocalToLocalConverter_OpenCL::SetPrimaryNodeSet(
...
void KFMElectrostaticLocalToLocalConverter_OpenCL::Finalize()
{
...
////////////////////////////////////////////////////////////////////////
void KFMElectrostaticLocalToLocalConverter_OpenCL::Initialize()
{
...
////////////////////////////////////////////////////////////////////////
void KFMElectrostaticLocalToLocalConverter_OpenCL::ApplyAction(KFMNode<KFMElectrostaticNodeObjects>* node)
{
            ...
            if (n_moment_sets != 0) {
                ...
                KOpenCLInterface::GetInstance()->GetQueue().enqueueWriteBuffer(
                    *fNodeIDBufferCL,
                    ...
                    &(fCachedPrimaryNodeIDLists[special_id][0]));
#ifdef ENFORCE_CL_FINISH
                KOpenCLInterface::GetInstance()->GetQueue().finish();
#endif
...
void KFMElectrostaticLocalToLocalConverter_OpenCL::BuildBuffers()
{
...
void KFMElectrostaticLocalToLocalConverter_OpenCL::AssignBuffers()
{
...
void KFMElectrostaticLocalToLocalConverter_OpenCL::ConstructTransformKernel()
{
    //Get name of kernel source file
    std::stringstream clFile;
    clFile << KOpenCLInterface::GetInstance()->GetKernelPath()
           << "/kEMField_KFMElectrostaticLocalToLocalTransformation_kernel.cl";
