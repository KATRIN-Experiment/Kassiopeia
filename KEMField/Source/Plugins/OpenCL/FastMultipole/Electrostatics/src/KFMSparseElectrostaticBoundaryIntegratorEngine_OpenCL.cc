...
const std::string KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::fWeightFilePrefix = std::string("spoclwlw_");
...
KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL()
{
    ...
    if (fUseBatchedKernels) {
        ...
        fM2LConverterInterface_Batched =
            new KFMRemoteToLocalConverterInterface<KFMElectrostaticNodeObjects,
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SetTree(KFMElectrostaticTree* tree)
{
    fTree = tree;
...
//set parameters
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SetParameters(KFMElectrostaticParameters params)
{
    ...
    if (fVerbosity > 4) {
        ...
        kfmout << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SetParameters: top level divisions set to "
               << params.top_level_divisions << kfmendl;
        kfmout << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SetParameters: divisions set to "
               << params.divisions << kfmendl;
        kfmout << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SetParameters: degree set to "
               << params.degree << kfmendl;
        kfmout << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SetParameters: zero mask size set to "
               << params.zeromask << kfmendl;
        kfmout << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SetParameters: max tree depth set to "
               << params.maximum_tree_depth << kfmendl;
    }
}


void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::Initialize()
{
    PrepareNodeSets();
    AllocateBuffers();
    ...
    if (fVerbosity > 4) {
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::Initialize: Initializing the multipole to multipole translator. ";
    }
    ...
    if (fVerbosity > 4) {
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::Initialize: Initializing the multipole to local translator. ";
    }
    ...
    if (fVerbosity > 4) {
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::Initialize: Initializing the local to local translator. ";
    }
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::MapField()
{
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::InitializeMultipoleMoments()
{
    ...
    if (fVerbosity > 4) {
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::InitializeMultipoleMoments: Done initializing multipole moment expansions."
            << kfmendl;
    }
}


void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::InitializeLocalCoefficientsForPrimaryNodes()
{
    ...
    if (fVerbosity > 4) {
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::InitializeLocalCoefficientsForPrimaryNodes: Done initializing local coefficient expansions."
            << kfmendl;
    }
}


void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ResetMultipoleMoments()
{
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeMultipoleMoments()
{
    ...
    if (fVerbosity > 4) {
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeMultipoleMoments: Done processing and distributing boundary element moments."
            << kfmendl;
    }

    if (fUseBatchedKernels) {
        fM2MConverter_Batched->Prepare();
        fTree->ApplyCorecursiveAction(fM2MConverter_Batched,
                                      false);  //false indicates this visitation proceeds from child to parent
        fM2MConverter_Batched->Finalize();
    }
    else {
        fTree->ApplyRecursiveAction(fM2MConverter,
                                    false);  //false indicates this visitation proceeds from child to parent
    }

    if (fVerbosity > 4) {
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeMultipoleMoments: Done performing the multipole to multipole (M2M) translations."
            << kfmendl;
    }
}

void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ResetLocalCoefficients()
{
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeMultipoleToLocal()
{
    if (fUseBatchedKernels) {
        ...
        if (fVerbosity > 4) {
            kfmout
                << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeLocalCoefficients: Done performing the multipole to local (M2L) translations."
                << kfmendl;
        }
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeLocalToLocal()
{
    if (fUseBatchedKernels) {
        ...
        if (fVerbosity > 4) {
            kfmout
                << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeLocalCoefficients: Done performing the local to local (L2L) translations."
                << kfmendl;
        }
    }
    else {
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeLocalCoefficients()
{
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::PrepareNodeSets()
{
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::RecieveTopLevelLocalCoefficients()
{
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::SendTopLevelLocalCoefficients()
{
    //read the primary node local coefficients back from the gpu;
    unsigned int stride = (fDegree + 1) * (fDegree + 2) / 2;
    unsigned int primary_size = fNTopLevelPrimaryNodes * stride;
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::AllocateBuffers()
{
    ...
    CL_ERROR_TRY
    {
        fMultipoleBufferCL = new cl::Buffer(KOpenCLInterface::GetInstance()->GetContext(),
                                            CL_MEM_READ_WRITE,
                                            fNMultipoleNodes * fNReducedTerms * sizeof(CL_TYPE2));
    }
    CL_ERROR_CATCH
    ...
    CL_ERROR_TRY
    {
        fLocalCoeffBufferCL = new cl::Buffer(KOpenCLInterface::GetInstance()->GetContext(),
                                             CL_MEM_READ_WRITE,
                                             fNPrimaryNodes * fNReducedTerms * sizeof(CL_TYPE2));
    }
    CL_ERROR_CATCH
}

void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::CheckDeviceProperites()
{
    ...
    if (multipole_size > max_buffer_size) {
        ...
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::BuildBuffers: Error. Cannot allocate multipole buffer of size: "
    ...
    if (local_coeff_size > max_buffer_size) {
        ...
        kfmout
            << "KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::BuildBuffers: Error. Cannot allocate local coefficient buffer of size: "
            << size_to_alloc_mb << " MB on a device with max allowable buffer size of: " << max_size_mb
            << " MB and total device memory of: " << total_size_mb << " MB." << kfmendl;
        kfmexit(1);
    }
...
void KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::EvaluateWorkLoads(unsigned int divisions,
...
double KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeDiskMatrixVectorProductWeight()
{
...
double KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeRamMatrixVectorProductWeight()
{
...
double KFMSparseElectrostaticBoundaryIntegratorEngine_OpenCL::ComputeFFTWeight(unsigned int divisions,
                                                                               unsigned int zeromask)
{
    unsigned int n_samples = 100;
