...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::SetTree(KFMElectrostaticTree* tree)
{
    fTree = tree;
...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::SetPrimaryNodeSet(KFMSpecialNodeSet<KFMElectrostaticNodeObjects>* primary_node_set)
{
...
////////////////////////////////////////////////////////////////////////////////
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::Prepare()
{
    ClearBuffers();
    fCachedNodeLevel = 0;
}
...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::Finalize()
{
...
////////////////////////////////////////////////////////////////////////
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::Initialize()
{
    ...
    if(nDummy == fNTransformLocal){nDummy = 0;};
...
////////////////////////////////////////////////////////////////////////
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::ApplyAction(KFMNode<KFMElectrostaticNodeObjects>* node)
{
...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::BufferNode(KFMNode<KFMElectrostaticNodeObjects>* node)
{
...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::ExecuteBufferedAction()
{
    if(fNBufferedNodes != 0)
    {
        ...
        KOpenCLInterface::GetInstance()->GetQueue().enqueueWriteBuffer(*fParentIDBufferCL, CL_TRUE, 0, fNBufferedNodes*sizeof(unsigned int), &(fParentIDBuffer[0]));
...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::ClearBuffers()
{
    fNBufferedNodes = 0;
    fNodeIDBuffer.clear();
...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::BuildBuffers()
{
...
//    fParentIDBufferCL;
    ...
    KOpenCLInterface::GetInstance()->GetQueue().enqueueWriteBuffer(*fNodeIDBufferCL, CL_TRUE, 0, fNMaxBufferedNodes*sizeof(unsigned int), &(zero_buff[0]) );

    KOpenCLInterface::GetInstance()->GetQueue().enqueueWriteBuffer(*fBlockSetIDListBufferCL, CL_TRUE, 0, fNMaxBufferedNodes*sizeof(unsigned int), &(zero_buff[0]) );

    KOpenCLInterface::GetInstance()->GetQueue().enqueueWriteBuffer(*fParentIDBufferCL, CL_TRUE, 0, fNMaxBufferedNodes*sizeof(unsigned int), &(zero_buff[0]) );
}

////////////////////////////////////////////////////////////////////////////////

void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::AssignBuffers()
{
...
void
KFMElectrostaticBatchedLocalToLocalConverter_OpenCL::ConstructTransformKernel()
{
    //Get name of kernel source file
    std::stringstream clFile;
    clFile << KOpenCLInterface::GetInstance()->GetKernelPath() << "/kEMField_KFMElectrostaticBatchedLocalToLocalTransformation_kernel.cl";
    ...
    fTransformKernel = k_builder.BuildKernel(clFile.str(), std::string("ElectrostaticBatchedLocalToLocalTransformation"),  build_flags );
