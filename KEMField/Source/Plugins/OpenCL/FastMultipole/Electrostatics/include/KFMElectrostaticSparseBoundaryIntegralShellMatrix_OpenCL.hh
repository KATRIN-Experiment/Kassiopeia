    ...
    KSquareMatrix<typename FastMultipoleIntegrator::Basis::ValueType>
{
  public:
    ...
    KFMElectrostaticSparseBoundaryIntegralShellMatrix_OpenCL(KSurfaceContainer& c,
  ...
  protected:
    ...
    void BuildBlockComputeKernel()
    {
        ...
        if (fVerbosity > 2) {
            kfmout
                << "KFMElectrostaticSparseBoundaryIntegralShellMatrix_OpenCL::BuildBlockComputeKernel: Number of local threads is: "
    ...
    void BuildBlockReduceKernel()
    {
        ...
        if (fVerbosity > 2) {
            kfmout
                << "KFMElectrostaticSparseBoundaryIntegralShellMatrix_OpenCL::BuildBlockReduceKernel: Number of local threads is: "
