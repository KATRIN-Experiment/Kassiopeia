            ...
            if( node != NULL && node->HasChildren() && node->GetLevel() != 0 )
            {
                ...
                if(this->ChildrenHaveNonZeroMoments(node))
                {
                    ...
                    if(this->fIsScaleInvariant)
                    {
                        ...
                        {
                            fScaleFactorArray[si]  = std::real( this->fKernelResponse->GetKernel()->GetSourceScaleFactor(si, scale) );
                        }
                    }
                    ...
                    if(this->fIsScaleInvariant)
                    {
                        ...
                        {
                            fParentMomentContribution[tsi] *= std::real( this->fKernelResponse->GetKernel()->GetTargetScaleFactor(tsi, scale) );
                        }
                    }
...
////////////////////////////////////////////////////////////////////////////////
        ...
        void PointwiseMultiplyAndAddOpenCL()
        {
            ...
            if(nDummy == fNReductionLocal){nDummy = 0;};
            n_global += nDummy;
...
////////////////////////////////////////////////////////////////////////////////
        ...
        virtual void ConstructKernel()
        {
            ...
            clFile << KOpenCLInterface::GetInstance()->GetKernelPath() << "/kEMField_KFMScalarMomentRemoteToRemoteConverter_kernel.cl";
...
////////////////////////////////////////////////////////////////////////////////
        ...
        virtual void ConstructReductionKernel()
        {
            //Get name of kernel source file
            std::stringstream clFile;
            clFile << KOpenCLInterface::GetInstance()->GetKernelPath() << "/kEMField_KFMScalarMomentArrayReduction_kernel.cl";
