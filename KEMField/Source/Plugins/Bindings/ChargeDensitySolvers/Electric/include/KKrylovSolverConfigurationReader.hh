...
#ifndef KEMFIELD_SOURCE_2_0_CHARGEDENSITYSOLVERS_ELECTRIC_INCLUDE_KKRYLOVSOLVERCONFIGURATIONREADER_HH_
#define KEMFIELD_SOURCE_2_0_CHARGEDENSITYSOLVERS_ELECTRIC_INCLUDE_KKRYLOVSOLVERCONFIGURATIONREADER_HH_
...
bool SetKrylovSolverMatrixAndPrecon(KContainer& anElement, ObjectType& fObject)
{
	if(anElement.Is<KEMField::KKrylovChargeDensitySolver::MatrixGenerator>()){
		KEMField::KSmartPointer<KEMField::KKrylovChargeDensitySolver::MatrixGenerator>
		matrixGenerator = ReleaseToSmartPtr<KEMField::KKrylovChargeDensitySolver::MatrixGenerator>
		(anElement);
...
template <class ObjectType>
bool SetKrylovSolverConfiguration(KContainer& aContainer, ObjectType& fObject)
{
...
#endif /* KEMFIELD_SOURCE_2_0_CHARGEDENSITYSOLVERS_ELECTRIC_INCLUDE_KKRYLOVSOLVERCONFIGURATIONREADER_HH_ */
