...
#ifndef KEMFIELD_SOURCE_2_0_PLUGINS_BINDINGS_CHARGEDENSITYSOLVERS_ELECTRIC_INCLUDE_KKRYLOVCHARGEDENSITYSOLVEROLDBUILDER_HH_
...
typedef KComplexElement< KEMField::KKrylovChargeDensitySolverOld >
KKrylovChargeDensitySolverOldBuilder;

template< >
inline bool KKrylovChargeDensitySolverOldBuilder::
		...
		AddElement(KContainer * anElement)
{
	if(anElement->GetName() == "fftm_multiplication"){
		anElement->ReleaseTo(fObject->GetSolverConfig(),
				&KEMField::KFMElectrostaticFastMultipoleBoundaryValueSolverConfiguration::
				SetFFTMParams);
		return true;
	}
...
#endif /* KEMFIELD_SOURCE_2_0_PLUGINS_BINDINGS_CHARGEDENSITYSOLVERS_ELECTRIC_INCLUDE_KKRYLOVCHARGEDENSITYSOLVEROLDBUILDER_HH_ */
