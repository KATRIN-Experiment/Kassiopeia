...
template< >
KFMVTKElectrostaticTreeViewerBuilder::~KComplexElement()
{
}
...
STATICINT sKElectricFastMultipoleFieldSolver =
		KElectricFastMultipoleFieldSolverBuilder::ComplexElement< KEMField::KFMVTKElectrostaticTreeViewerData >
		( "viewer" );
