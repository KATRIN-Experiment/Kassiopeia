...
{
    KEMField::cout << "Pulling elements from " << KLineCurrent::Name() << " and putting them in VTK arrays"
                   << KEMField::endl;
...
{
    KEMField::cout << "Pulling elements from " << KCurrentLoop::Name() << " and putting them in VTK arrays"
                   << KEMField::endl;
...
{
    KEMField::cout << "Pulling elements from " << KSolenoid::Name() << " and putting them in VTK arrays"
                   << KEMField::endl;
