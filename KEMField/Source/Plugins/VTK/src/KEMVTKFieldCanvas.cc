...
namespace KEMField
{
KEMVTKFieldCanvas::KEMVTKFieldCanvas(double x_1, double x_2, double y_1, double y_2, double zmir, bool isfull) :
                                     ...
                                     const std::vector<double>& V, bool xy, double z)
{
    ...
    transferFunction->AddRGBSegment(min + 0.0 * range, 0.5, 0.0, 1.0, min + 0.2 * range, 0.0, 0.0, 1.0);
    transferFunction->AddRGBSegment(min + 0.2 * range, 0.0, 0.0, 1.0, min + 0.4 * range, 0.0, 1.0, 1.0);
    transferFunction->AddRGBSegment(min + 0.4 * range, 0.0, 1.0, 1.0, min + 0.6 * range, 0.0, 1.0, 0.0);
