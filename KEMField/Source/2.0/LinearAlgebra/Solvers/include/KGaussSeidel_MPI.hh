...
namespace KEMField
{
  ...
  template <typename ValueType>
  KGaussSeidel_MPI<ValueType>::~KGaussSeidel_MPI()
  {
    delete [] fRanges;
    delete [] fOffsets;
  }
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::Initialize()
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::FindResidual()
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::FindResidualNorm(double& residualNorm)
  {
    residualNorm = 0.;
    for (unsigned int i=0;i<fResidual.Dimension();i++)
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::IncrementIndex()
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::IncrementIndex(Type2Type<double>)
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::IncrementIndex(Type2Type<std::complex<double> >)
  {
    unsigned int source = 0;
    while (((unsigned int)fOffsets[source])<=fIndex)
    {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::ComputeCorrection()
  {
    ComputeCorrection(Type2Type<ValueType>());
  }

  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::ComputeCorrection(Type2Type<double>)
  {
    fCorrection = fRes_real.fCorrection;
  }

  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::ComputeCorrection(Type2Type<std::complex<double> >)
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::UpdateSolutionApproximation()
  {
    fX[fIndex] += fCorrection;
  }

  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::UpdateVectorApproximation()
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::Finalize()
  {
    MPI_Barrier(MPI_COMM_WORLD);
  }

  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::SetResidualVector(const Vector& v)
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::GetResidualVector(Vector& v)
  {
    GetResidualVector(Type2Type<ValueType>(),v);
  }

  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::GetResidualVector(Type2Type<double>,Vector& v)
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::InitializeMPIStructs(Type2Type<double>)
  {
  ...
  template <typename ValueType>
  void KGaussSeidel_MPI<ValueType>::InitializeMPIStructs(Type2Type<std::complex<double> >)
  {
