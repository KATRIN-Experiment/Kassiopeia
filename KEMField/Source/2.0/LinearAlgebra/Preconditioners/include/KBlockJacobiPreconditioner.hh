...
class KBlockJacobiPreconditioner: public KPreconditioner< ValueType >
{
    public:

        KBlockJacobiPreconditioner(const KSquareMatrix<ValueType>& A, const std::vector< const std::vector<unsigned int>* >* block_index_lists):
        ...
        virtual std::string Name(){ return std::string("bjacobi"); };
