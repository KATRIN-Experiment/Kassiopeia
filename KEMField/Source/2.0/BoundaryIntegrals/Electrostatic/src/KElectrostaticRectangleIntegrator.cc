...
namespace KEMField
{
   ...
   */
  double KElectrostaticRectangleIntegrator::Potential(const KRectangle* source,
  ...
  KEMThreeVector KElectrostaticRectangleIntegrator::ElectricField(const KRectangle* source,
								const KPosition& P) const
  {
    KEMThreeVector p = P - source->GetP0();
    double uP = p.Dot(source->GetN1());
   ...
   * \f]
   */
  double KElectrostaticRectangleIntegrator
  ...
  EFieldLocalZ(double x1,double x2,double y1,double y2,double z) const
  {
    ...
    double KElectrostaticRectangleIntegrator::Potential(const KSymmetryGroup<KRectangle>* source, const KPosition& P) const
    {
      double potential = 0.;
    ...
    KEMThreeVector KElectrostaticRectangleIntegrator::ElectricField(const KSymmetryGroup<KRectangle>* source, const KPosition& P) const
    {
