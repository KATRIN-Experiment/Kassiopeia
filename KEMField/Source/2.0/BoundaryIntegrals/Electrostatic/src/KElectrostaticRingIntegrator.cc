 ...
 * \f}
 */
  double KElectrostaticRingIntegrator::Potential(const KRing* source,const KPosition& P) const
  {
    double par[7];
  ...
  KEMThreeVector KElectrostaticRingIntegrator::ElectricField(const KRing* source,const KPosition& P) const
  {
    double par[7];
   ...
   * @endcode
   */
  double KElectrostaticRingIntegrator::PotentialFromChargedRing(const double *P,double *par)
  {
   ...
   * @endcode
   */
  double KElectrostaticRingIntegrator::EFieldRFromChargedRing(const double *P,double *par)
  {
   ...
   * @endcode
   */
  double KElectrostaticRingIntegrator::EFieldZFromChargedRing(const double *P,double *par)
  {
    static KCompleteEllipticIntegral2ndKind E_elliptic;
    double Z = par[2]+P[0]/par[6]*(par[4]-par[2]);
    double R = par[3]+P[0]/par[6]*(par[5]-par[3]);
  ...
  double KElectrostaticRingIntegrator::Potential(const KSymmetryGroup<KRing>* source, const KPosition& P) const
  {
    double potential = 0.;
  ...
  KEMThreeVector KElectrostaticRingIntegrator::ElectricField(const KSymmetryGroup<KRing>* source, const KPosition& P) const
  {
