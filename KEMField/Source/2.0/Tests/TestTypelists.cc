...
template<>
struct ListClassNames_trait<KEMField::KNullType>
{
...
struct ListClassNames_trait< KEMField::KTypelist<T,U> >
{
  static void ListClassNames()
  {
...
public:
  A() {}
  ~A() {}
  static std::string ClassName() { return std::string("A"); }
};
...
public:
  B() {}
  ~B() {}
  static std::string ClassName() { return std::string("B"); }
};
...
public:
  C() {}
  ~C() {}
  static std::string ClassName() { return std::string("C"); }
};
...
int main()
{
  ...
  std::cout << "IndexOf   IndexOf<(I,F,S), I>: 0 - " 
	    << KEMField::IndexOf< List0, int >::value << "\n";
  std::cout << "IndexOf   IndexOf<(I,F,S), S>: 2 - " 
	    << KEMField::IndexOf< List0, std::string >::value << "\n";
  ...
  std::cout << "Append<(I,S,F),B>          IndexOf<(I,F,S,B), B>: 3 - "
	    << KEMField::IndexOf< List1, bool >::value << "\n";
  ...
  std::cout << "Erase<(I,F,S,B),S>         IndexOf<(I,F,B), B>: 2 - "
	    << KEMField::IndexOf< List2, bool >::value << "\n";
