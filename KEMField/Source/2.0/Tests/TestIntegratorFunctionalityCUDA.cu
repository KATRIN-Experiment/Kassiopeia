...
int main()
{
    // Functionality test for CUDA boundary integrator classes and computation of numeric constants
    ...
    KCUDASurfaceContainer* cuContainer;
    if( data )
        cuContainer = dynamic_cast< KCUDASurfaceContainer* >( data );
    else {
        cuContainer = new KCUDASurfaceContainer( *surfaceContainer );
...
#ifdef TRI
    KElectrostaticTriangleIntegrator intTriAna;
...
#ifdef RECT
    KElectrostaticRectangleIntegrator intRectAna;
...
#ifdef LINE
    KElectrostaticLineSegmentIntegrator intLineAna;
    ...
    std::cout << "\t GPU:       " << intCUNum.Potential( tL->GetShape(), evalPoint ) << std::endl;
    std::cout << "\t Field+Pot: " << intCUNum.ElectricFieldAndPotential( tL->GetShape(), evalPoint ).second << std::endl;
    ...
    std::cout << "\t GPU:       " << intCUNum.Potential( rL->GetShape(), evalPoint ) << std::endl;
    std::cout << "\t Field+Pot: " << intCUNum.ElectricFieldAndPotential( rL->GetShape(), evalPoint ).second << std::endl;
    ...
    std::cout << "\t GPU:       " << intCUNum.Potential( wL->GetShape(), evalPoint ) << std::endl;
    std::cout << "\t Field+Pot: " << intCUNum.ElectricFieldAndPotential( wL->GetShape(), evalPoint ).second << std::endl;
    ...
    printVec("\t GPU:       ", intCUNum.ElectricField(tL->GetShape(),evalPoint));
    printVec("\t Field+Pot: ", intCUNum.ElectricFieldAndPotential( tL->GetShape(), evalPoint ).first);
    ...
    printVec("\t GPU:       ", intCUNum.ElectricField(rL->GetShape(),evalPoint));
    printVec("\t Field+Pot: ", intCUNum.ElectricFieldAndPotential( rL->GetShape(), evalPoint ).first);
    ...
    printVec("\t GPU:      ", intCUNum.ElectricField(wL->GetShape(),evalPoint ));
    printVec("\t Field+Pot:", intCUNum.ElectricFieldAndPotential( wL->GetShape(), evalPoint ).first);
#endif
