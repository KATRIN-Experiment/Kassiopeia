...
void FieldPotTri7P_Cached( double* data, const double* P, double* cub7Q, double* result )
{
	...
	const double triArea = 0.5*data[0]*data[1]*sqrt(
...
void GaussPoints_Tri12P( const double* data, double* Q )
{
	...
	const double fCub12alpha[5]={0.6238226509439084e-1,  0.5522545665692000e-1,  0.3432430294509488e-1, 0.5158423343536001};
...
{
	const double fCub12w4[4] = {0.2651702815743450e-1, 0.4388140871444811e-1, 0.2877504278497528e-1, 0.6749318700980879e-1 };
	const double fCub12w[12] = {fCub12w4[0]*2., fCub12w4[0]*2., fCub12w4[0]*2.,
			fCub12w4[1]*2., fCub12w4[1]*2., fCub12w4[1]*2.,
			fCub12w4[2]*2., fCub12w4[2]*2., fCub12w4[2]*2., fCub12w4[3]*2., fCub12w4[3]*2., fCub12w4[3]*2.};
