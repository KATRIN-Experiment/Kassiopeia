...
class KFMScalarMomentRemoteToLocalConverter: public KFMNodeActor< KFMNode<ObjectTypeList> >
{
    ...
    protected:
        ...
        void CreateAndAssociateArrayWrappers()
        {
            ...
            fAllMultipoles = new KFMArrayWrapper<std::complex<double>, SpatialNDIM + 1>(fPtrMultipoles, &(fDimensionSize[1]) );
            fAllLocalCoeff = new KFMArrayWrapper<std::complex<double>, SpatialNDIM + 1>(fPtrLocalCoeff, &(fDimensionSize[1]));
            fAllOrigLocalCoeff = new KFMArrayWrapper<std::complex<double>, SpatialNDIM + 1>(fPtrOrigLocalCoeff, &(fDimensionSize[1]));
        ...
        void DeallocateCalculatorSpace()
        {
            ...
            for(unsigned int tsi=0; tsi<fM2LCoeff.size(); tsi++)
            {
                ...
                {
                    delete fM2LCoeff[tsi][ssi]; fM2LCoeff[tsi][ssi] = NULL;
                }
