...
int main(int argc, char** argv)
{
  ...
  std::string usage =
    "\n"
    "Usage: TestFastMultipoleFieldSolver <options>\n"
    "\n"
    ...
    "\t                           1: Robin Hood, \n"
    "\t                           2: Fast Multipole w/ GMRES, \n"
    "\t                           3: Fast Multipole w/ BiCGStab) \n"
    "\t                           4: Fast Multipole w/ RH-PGMRES) \n"
    "\t -r, --n-restart          (number of iterations before GMRES restart) \n"
    ...
    static struct option longOptions[] =
    {
        ...
        {"n-restart", required_argument, 0, 'r'},
    ...
    static const char *optString = "ha:s:g:t:r:n:p:d:z:m:e:";
...
//        box->SetZMeshPower(2);
    ...
    switch(type)
    {
        ...
        break;
        case 2: //fast multipole with GMRES
            {
            ...
            restart_cond->SetNumberOfIterationsBetweenRestart(restart);
        ...
        break;
        case 3: //fast mutipole with BiCGStab
            {
        ...
        case 4: //fast multipole with Robin-Hood preconditioned GMRES
            {
            FastMultipoleEBI* fm_integrator = new FastMultipoleEBI(surfaceContainer);
            fm_integrator->Initialize(params);
            KFMBoundaryIntegralMatrix< FastMultipoleEBI > fmA(surfaceContainer, *fm_integrator);
            ...
            //#else
            KRobinHoodPreconditioner<FastMultipoleEBI::ValueType, KRobinHood_SingleThread> RHP(fmA, 500);
            //#endif
