...
int main(int argc, char** argv)
{
    ...
    restart_cond->SetNumberOfIterationsBetweenRestart(30);
...
//    KFMElectrostaticFastMultipoleFieldSolver* fast_solver = new KFMElectrostaticFastMultipoleFieldSolver(surfaceContainerB, *e_tree);
    ...
    //save the surface containers to file
    KEMFileInterface::GetInstance()->Write(surfaceContainerA,"surfaceContainerA");
    KEMFileInterface::GetInstance()->Write(surfaceContainerB,"surfaceContainerB");
