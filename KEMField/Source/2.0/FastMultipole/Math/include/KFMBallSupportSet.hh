...
class KFMBallSupportSet
{
    public:
        ...
        unsigned int GetNSupportPoints(){return fSupportPoints.size();};
        ...
        bool ComputeBoundingBall(const KFMPoint<NDIM>* new_point,
                                   const std::vector< KFMPoint<NDIM> >* points,
                                   std::bitset< sizeof(unsigned int)*CHAR_BIT > mask,
                                   KFMBall<NDIM>& ball)
        {
        ...
        bool CheckValidity(const std::vector< KFMPoint<NDIM> >* points,
                             std::bitset< sizeof(unsigned int)*CHAR_BIT > mask,
