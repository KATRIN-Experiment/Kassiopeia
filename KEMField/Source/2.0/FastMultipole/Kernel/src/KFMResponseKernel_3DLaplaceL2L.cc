...
bool
KFMResponseKernel_3DLaplaceL2L::IsPhysical(int source_index, const int target_index) const
{
    int j,k,n,m;
...
std::complex<double>
KFMResponseKernel_3DLaplaceL2L::GetResponseFunction(int source_index, int target_index) const
{
    int j,k,n,m;
...
std::complex<double>
KFMResponseKernel_3DLaplaceL2L::GetSourceScaleFactor(int source_index, std::complex<double>& scale) const
{
    int n;
    n = KFMScalarMultipoleExpansion::ComplexDegreeReverseLookUp(source_index);
...
std::complex<double>
KFMResponseKernel_3DLaplaceL2L::GetTargetScaleFactor(int target_index, std::complex<double>& scale) const
{
    int j;
    j = KFMScalarMultipoleExpansion::ComplexDegreeReverseLookUp(target_index);
...
std::complex<double>
KFMResponseKernel_3DLaplaceL2L::GetNormalizationFactor(int source_index, int target_index) const
{
    int j,k,n,m;
...
std::complex<double>
KFMResponseKernel_3DLaplaceL2L::GetIndependentResponseFunction(int response_index) const
{
    int j,k;
