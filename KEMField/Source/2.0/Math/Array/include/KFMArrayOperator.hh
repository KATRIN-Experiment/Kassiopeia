...
class KFMArrayOperator
{
    public:
        ...
        //utilities
        static bool
        HaveSameNumberOfElements(const KFMArrayWrapper<T,NDIM>* arr1, const KFMArrayWrapper<T,NDIM>* arr2)
        {
            return ( arr1->GetArraySize() == arr2->GetArraySize() );
        }

        static bool
        HaveSameDimensions(const KFMArrayWrapper<T,NDIM>* arr1, const KFMArrayWrapper<T,NDIM>* arr2)
        {
        ...
        static void
        ResetArray(KFMArrayWrapper<T,NDIM>* arr, const T& obj)
        {
            T* ptr = arr->GetData();
        ...
        static bool
        IsBoundedDomainSubsetOfArray(KFMArrayWrapper<T,NDIM>* arr,
