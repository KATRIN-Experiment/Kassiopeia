...
namespace KEMField
{
   ...
   */
  void KGaussianQuadrature::operator() (double (**f)(const double*,double*),
					int m,
					double a,
					double b,
					double *par,
					...
					double *ans) const
  {
    int i,j;
    double deln;
    static const double w5[6]={0.3187500000000000e+00,0.1376388888888889e+01,
				 0.6555555555555556e+00,0.1212500000000000e+01,
				 0.9256944444444445e+00,0.1011111111111111e+01};
    static const double w9[10]={ 0.2803440531305107e0,0.1648702325837748e1,
