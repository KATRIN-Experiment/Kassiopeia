...
template< >
KRampedElectricFieldBuilder::~KComplexElement()
{
}

STATICINT sKRampedElectricFieldStructure =
        KRampedElectricFieldBuilder::Attribute< string >( "name" ) +
...
STATICINT sKRampedElectricField =
        KEMToolboxBuilder::ComplexElement< KRampedElectricField >( "ramped_electric_field" );
