...
class KFMElectrostaticSparseBoundaryIntegralShellMatrix_MPI_OpenCL: KSquareMatrix<typename FastMultipoleIntegrator::Basis::ValueType>
{
    public:
        ...
        KFMElectrostaticSparseBoundaryIntegralShellMatrix_MPI_OpenCL(KSurfaceContainer& c, FastMultipoleIntegrator& integrator):
...
////////////////////////////////////////////////////////////////////////////////
        ...
        void BuildBlockComputeKernel()
        {
            ...
            if(fVerbosity > 2)
            {
                kfmout<<"KFMElectrostaticSparseBoundaryIntegralShellMatrix_MPI_OpenCL::BuildBlockComputeKernel: Number of local threads is: "<<fNComputeLocal<<kfmendl;
            }
        }
        ...
        void BuildBlockReduceKernel()
        {
            ...
            if(fVerbosity > 2)
            {
                kfmout<<"KFMElectrostaticSparseBoundaryIntegralShellMatrix_MPI_OpenCL::BuildBlockReduceKernel: Number of local threads is: "<<fNReduceLocal<<kfmendl;
            }
        }
