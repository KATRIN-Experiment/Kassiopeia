...
namespace KEMField
{
  ...
  class KVTKIterationPlotter : public KIterativeSolver<ValueType>::Visitor
  {
  public:
  ...
  template <typename ValueType>
  void KVTKIterationPlotter<ValueType>::InitializePlot()
  {
  ...
  template <typename ValueType>
  void KVTKIterationPlotter<ValueType>::CreatePlot()
  {
  ...
  template <typename ValueType>
  void KVTKIterationPlotter<ValueType>::AddPoint(float x,float y)
  {
  ...
  template <typename ValueType>
  void KVTKIterationPlotter<ValueType>::Initialize(KIterativeSolver<ValueType>&)
  {
    InitializePlot();
  }

  template <typename ValueType>
  void KVTKIterationPlotter<ValueType>::Visit(KIterativeSolver<ValueType>& solver)
  {    
    AddPoint(solver.Iteration(),solver.ResidualNorm());
  }

  template <typename ValueType>
  void KVTKIterationPlotter<ValueType>::Finalize(KIterativeSolver<ValueType>&)
  {
