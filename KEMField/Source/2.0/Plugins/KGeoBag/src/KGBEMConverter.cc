...
namespace KGeoBag
{
    ...
    KEMThreeVector KGBEMConverter::GlobalToInternalPosition( const KThreeVector& aVector )
    {
    ...
    KEMThreeVector KGBEMConverter::GlobalToInternalVector( const KThreeVector& aVector )
    {
        KThreeVector tVector( aVector );
        return KEMThreeVector( tVector.Dot( fXAxis ), tVector.Dot( fYAxis ), tVector.Dot( fZAxis ) );
    }
    KThreeVector KGBEMConverter::InternalToGlobalPosition( const KEMThreeVector& aVector )
    {
    ...
    KThreeVector KGBEMConverter::InternalToGlobalVector( const KEMThreeVector& aVector )
    {
