...
namespace KGeoBag
{
    ...
    KEMThreeVector KGElectromagnetConverter::GlobalToInternalPosition( const KThreeVector& aVector )
    {
        KThreeVector tPosition( aVector - fOrigin );
        return KEMThreeVector( tPosition.Dot( fXAxis ), tPosition.Dot( fYAxis ), tPosition.Dot( fZAxis ) );
    }
    KEMThreeVector KGElectromagnetConverter::GlobalToInternalVector( const KThreeVector& aVector )
    {
        KThreeVector tVector( aVector );
        return KEMThreeVector( tVector.Dot( fXAxis ), tVector.Dot( fYAxis ), tVector.Dot( fZAxis ) );
    }
    KThreeVector KGElectromagnetConverter::InternalToGlobalPosition( const KEMThreeVector& aVector )
    {
    ...
    KThreeVector KGElectromagnetConverter::InternalToGlobalVector( const KEMThreeVector& aVector )
    {
    ...
    {
        KEMThreeMatrix tTransform(fXAxis[0],fYAxis[0],fZAxis[0],
