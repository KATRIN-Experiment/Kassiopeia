#ifndef KEMFIELD_GAUSSIANQUADRATURE_CUH
#define KEMFIELD_GAUSSIANQUADRATURE_CUH
...
#define GaussianQuadrature(FUNCTION)					\
  __forceinline__ __device__ CU_TYPE GaussianQuadrature_ ## FUNCTION (CU_TYPE a,			\
					   CU_TYPE b,			\
					   int n,			\
					   CU_TYPE* par)		\
  {									\
    int i,j;								\
    CU_TYPE deln;							\
    CU_TYPE w5[6]={0.3187500000000000e+00,0.1376388888888889e+01,	\
		   0.6555555555555556e+00,0.1212500000000000e+01,	\
		   0.9256944444444445e+00,0.1011111111111111e+01};	\
    CU_TYPE w9[10]={ 0.2803440531305107e0,0.1648702325837748e1,		\
...
#endif /* KEMFIELD_GAUSSIANQUADRATURE_CUH */
