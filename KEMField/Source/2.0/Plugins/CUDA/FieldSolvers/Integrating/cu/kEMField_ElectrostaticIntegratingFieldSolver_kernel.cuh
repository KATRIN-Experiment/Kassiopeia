...
__global__ void ElectricFieldKernel( const CU_TYPE *P,
        const short *shapeType,
        const CU_TYPE *shapeData,
        const CU_TYPE *basisData,
        CU_TYPE4 *eField )
...
__global__ void SubsetPotentialKernel( const CU_TYPE *P,
        const short *shapeType,
        const CU_TYPE *shapeData,
        const CU_TYPE *basisData,
        CU_TYPE* phi,
...
__global__ void SubsetElectricFieldKernel( const CU_TYPE *P,
        const short *shapeType,
        const CU_TYPE *shapeData,
        const CU_TYPE *basisData,
        CU_TYPE4* eField,
