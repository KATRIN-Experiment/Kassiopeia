...
class KZonalHarmonicParameters
{
  public:
    ...
    void SetConvergenceRatio(double d)
    {
        fConvergenceRatio = d;
    }
    void SetProximityToSourcePoint(double d)
    {
        fProximityToSourcePoint = d;
    }
    void SetConvergenceParameter(double d)
    {
        fConvergenceParameter = d;
    }
    void SetCoaxialityTolerance(double d)
    {
        fCoaxialityTolerance = d;
    }
    void SetNCentralCoefficients(unsigned int i)
    {
        fNCentralCoefficients = i;
    }
    void SetCentralFractionalSpacing(bool b)
    {
        fCentralFractionalSpacing = b;
    }
    void SetCentralFractionalDistance(double d)
    {
        fCentralFractionalDistance = d;
    }
    void SetCentralDeltaZ(double d)
    {
        fCentralDeltaZ = d;
    }
    void SetCentralZ1(double d)
    {
        fCentralZ1 = d;
    }
    ...
    {
        fNRemoteCoefficients = i;
    }
    void SetNRemoteSourcePoints(unsigned int i)
    {
        fNRemoteSourcePoints = i;
    }
    void SetRemoteZ1(double d)
    {
        fRemoteZ1 = d;
    }
    void SetRemoteZ2(double d)
    {
        fRemoteZ2 = d;
    }
    ...
    {
        return fConvergenceRatio;
    }
    double GetProximityToSourcePoint() const
    {
        return fProximityToSourcePoint;
    }
    double GetConvergenceParameter() const
    {
        return fConvergenceParameter;
    }
    double GetCoaxialityTolerance() const
    {
        return fCoaxialityTolerance;
    }
    unsigned int GetNCentralCoefficients() const
    {
        return fNCentralCoefficients;
    }
    bool GetCentralFractionalSpacing() const
    {
        return fCentralFractionalSpacing;
    }
    double GetCentralFractionalDistance() const
    {
        return fCentralFractionalDistance;
    }
    double GetCentralDeltaZ() const
    {
        return fCentralDeltaZ;
    }
    double GetCentralZ1() const
    {
        return fCentralZ1;
    }
    double GetCentralZ2() const
    {
        return fCentralZ2;
    }
    ...
    unsigned int GetNRemoteSourcePoints() const
    {
        return fNRemoteSourcePoints;
    }
    double GetRemoteZ1() const
    {
        return fRemoteZ1;
    }
    double GetRemoteZ2() const
    {
        return fRemoteZ2;
    }
...
template<typename Stream> Stream& operator>>(Stream& s, KZonalHarmonicParameters& p)
{
    ...
    s >> d;
    p.SetConvergenceRatio(d);
    s >> d;
    p.SetProximityToSourcePoint(d);
    s >> d;
    ...
    s >> d;
    p.SetCentralFractionalDistance(d);
    s >> d;
    p.SetCentralDeltaZ(d);
    s >> d;
    p.SetCentralZ1(d);
    s >> d;
    p.SetCentralZ2(d);
...
template<typename Stream> Stream& operator<<(Stream& s, const KZonalHarmonicParameters& p)
{
