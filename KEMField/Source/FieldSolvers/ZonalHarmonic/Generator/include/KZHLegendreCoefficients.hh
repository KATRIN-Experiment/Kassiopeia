...
class KZHLegendreCoefficients
{
  public:
    ...
    const double* GetRawPointerToRow(int i) const
    {
        return &(c[i][0]);
    }

  protected:
    KZHLegendreCoefficients()
    {
        c.resize(12);
    }
    ...
    std::vector<std::vector<double>>
        c;  ///< c1-c12 are coefficients related to the recursive definitions of Legendre polynomials
};
}  // namespace KEMField
