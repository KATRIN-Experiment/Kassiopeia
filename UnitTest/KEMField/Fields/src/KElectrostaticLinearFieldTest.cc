...
TEST_CASE_FIXTURE(KEMFieldTest, "KEMFieldTest - KElectrostaticLinearField_Potential")
{
...
TEST_CASE_FIXTURE(KEMFieldTest, "KEMFieldTest - KElectrostaticLinearField_Initialize")
{
    KElectrostaticLinearField field;
    field.Initialize();
}
