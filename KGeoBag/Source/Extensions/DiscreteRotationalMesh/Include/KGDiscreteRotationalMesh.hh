...
namespace KGeoBag
{
    ...
    class KGDiscreteRotationalMeshData
    {
        public:
            ...
            KGDiscreteRotationalMeshData(KGSpace*, const KGDiscreteRotationalMeshData& aCopy) {fElements = aCopy.fElements;}
			KGDiscreteRotationalMeshData(KGSurface*, const KGDiscreteRotationalMeshData& aCopy) {fElements = aCopy.fElements;}
