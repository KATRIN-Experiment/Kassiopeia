...
KGRotatedLineSegmentSpaceMesher::KGRotatedLineSegmentSpaceMesher() : KGSimpleMesher() {}
...
void KGRotatedLineSegmentSpaceMesher::VisitRotatedOpenPathSpace(KGRotatedLineSegmentSpace* aRotatedLineSegmentSpace)
{
    ...
    if (aRotatedLineSegmentSpace->StartPath()) {
        ...
        ClosedPointsFlattenedToTubeMeshAndApex(tStartCirclePoints,
                                               ...
                                               aRotatedLineSegmentSpace->FlattenedMeshCount(),
                                               aRotatedLineSegmentSpace->FlattenedMeshPower(),
                                               tStartMeshPoints,
                                               tStartApex);
