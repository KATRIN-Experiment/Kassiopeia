...
KThreeVector KGMeshTriangle::NearestPoint(const KThreeVector& aPoint) const
{
...
KThreeVector KGMeshTriangle::NearestNormal(const KThreeVector& /*aPoint*/) const
{
    return (fN1.Cross(fN2)).Unit();
}

bool KGMeshTriangle::NearestIntersection(const KThreeVector& aStart, const KThreeVector& anEnd,
