...
class KGNavigableMeshTreeBuilder
{
    public:
        ...
        void SetMaxTreeDepth(unsigned int d){fMaximumTreeDepth = d; fUseAuto = false; fUseSpatialResolution = false;};
        unsigned int GetMaxTreeDepth() const {return fMaximumTreeDepth;};

        void SetSpatialResolution(double r){fSpatialResolution = r; fUseAuto = false; fUseSpatialResolution = true;}

        void SetNAllowedElements(unsigned int n){fNAllowedElements = n;};
        unsigned GetNAllowedElements() const {return fNAllowedElements;};
        ...
        double GetRegionSideLength() const {return fRegionSideLength;};

        std::string GetInformation() const {return fInfoString;};
