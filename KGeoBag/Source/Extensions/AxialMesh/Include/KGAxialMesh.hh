...
namespace KGeoBag
{
    ...
    class KGAxialMeshData
    {
        public:
            ...
            KGAxialMeshData(KGSurface*, const KGAxialMeshData& aCopy) {fAxialMeshElements = aCopy.fAxialMeshElements;}
			KGAxialMeshData(KGSpace*, const KGAxialMeshData& aCopy) {fAxialMeshElements = aCopy.fAxialMeshElements;}
