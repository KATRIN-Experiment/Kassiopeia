...
class KGConicSectPortHousing : public KGBoundary
{
  public:
    ...
    {
        return "conic_section_port_housing";
    }
    ...
    void AddParaxialPort(double asub[3], double rsub);

    void AddOrthogonalPort(double asub[3], double rsub);

    void SetZAMain(double d)
    {
        fzAMain = d;
    }
    void SetZBMain(double d)
    {
        fzBMain = d;
    }
    void SetRAMain(double d)
    {
        frAMain = d;
    }
    void SetRBMain(double d)
    {
        frBMain = d;
    }
    ...
    double GetZAMain() const
    {
        return fzAMain;
    }
    double GetZBMain() const
    {
        return fzBMain;
    }
    double GetRAMain() const
    {
        return frAMain;
    }
    double GetRBMain() const
    {
        return frBMain;
    }
    ...
    class Port
    {
      public:
        ...
        void SetBoxRInner(double d) const
        {
            fBoxRInner = d;
        }
        void SetBoxROuter(double d) const
        {
            fBoxROuter = d;
        }
        void SetBoxAngle(double d) const
        {
            fBoxAngle = d;
        }
        void SetBoxTheta(double d) const
        {
            fBoxTheta = d;
        }

        double GetBoxRInner() const
        {
            return fBoxRInner;
        }
        double GetBoxROuter() const
        {
            return fBoxROuter;
        }
        double GetBoxAngle() const
        {
            return fBoxAngle;
        }
        double GetBoxTheta() const
        {
            return fBoxTheta;
        }

        const KGConicSectPortHousing* GetPortHousing() const
        {
            return fPortHousing;
        }
        void SetPortHousing(KGConicSectPortHousing* p)
        {
            fPortHousing = p;
        }
    ...
    class OrthogonalPort : public KGConicSectPortHousing::Port
    {
      public:
        ...
        void SetCylDisc(int i) const
        {
            fCylDisc = i;
        }
        void SetAlphaPolySub(int i) const
        {
            fAlphaPolySub = i;
        }
        ...
        int GetCylDisc() const
        {
            return fCylDisc;
        }
        int GetAlphaPolySub() const
        {
            return fAlphaPolySub;
        }
        int GetPolySub() const
        {
            return fPolySub;
        }
        double GetCen(unsigned int i) const
        {
            return (i < 3 ? fCen[i] : 0);
        }
        double GetX_loc(unsigned int i) const
        {
            return (i < 3 ? fX_loc[i] : 0);
        }
        double GetY_loc(unsigned int i) const
        {
            return (i < 3 ? fY_loc[i] : 0);
        }
        double GetZ_loc(unsigned int i) const
        {
            return (i < 3 ? fZ_loc[i] : 0);
        }
      ...
      private:
        void ComputeLocalFrame(double* cen, double* x, double* y, double* z);
    ...
    class ParaxialPort : public KGConicSectPortHousing::Port
    {
      public:
        ...
        double GetSymmetricLength() const
        {
            return fSymmetricLength;
        }
        double GetAsymmetricLength() const
        {
            return fAsymmetricLength;
        }
    ...
    const KGConicSectPortHousing::Port* GetPort(int i) const
    {
        return fPorts.at(i);
    }
