...
class KGComplexAnnulus : public KGBoundary
{
  public:
    ...
    {
        return "complex_annulus";
    }

    void AddRing(double ASub[2], double rsub);
    ...
    void SetRMain(double r)
    {
        fRMain = r;
    }
    void SetRadialMeshMain(int i) const
    {
        fRadialMeshMain = i;
    }
    ...
    int GetRadialMeshMain() const
    {
        return fRadialMeshMain;
    }
    ...
    class Ring
    {
      public:
        ...
        KGComplexAnnulus* GetComplexAnnulus() const
        {
            return fComplexAnnulus;
        }
        void SetComplexAnnulus(KGComplexAnnulus* a)
        {
            fComplexAnnulus = a;
        }
        ...
        {
            return (i < 2) ? fNorm[i] : 0;
        }

        // discretization parameters
        void SetRadialMeshSub(int i) const
        {
            fRadialMeshSub = i;
        }
        ...
        int GetRadialMeshSub() const
        {
            return fRadialMeshSub;
        }
    ...
    const KGComplexAnnulus::Ring* GetRing(int i) const
    {
        return const_cast<const KGComplexAnnulus::Ring*>(fRings.at(i));
    }
