...
namespace KGeoBag
{
    ...
    KGPlanarArcSegment::KGPlanarArcSegment( const KTwoVector& aStart, const KTwoVector& anEnd, const double& aRadius, const bool& isRight, const bool& isShort, const unsigned int aCount ) :
            fStart( aStart ),
            fEnd( anEnd ),
            fRadius( aRadius ),
            fRight( isRight ),
    ...
    KGPlanarArcSegment::KGPlanarArcSegment( const double& anX1, const double& aY1, const double& anX2, const double& aY2, const double& aRadius, const bool& isRight, const bool& isShort, const unsigned int aCount ) :
            fStart( anX1, aY1 ),
            fEnd( anX2, aY2 ),
            fRadius( aRadius ),
            fRight( isRight ),
