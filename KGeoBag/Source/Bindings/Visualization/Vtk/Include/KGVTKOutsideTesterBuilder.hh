...
typedef KComplexElement<KGeoBag::KGVTKOutsideTester> KGVTKOutsideTesterBuilder;

template<> inline bool KGVTKOutsideTesterBuilder::AddAttribute(KContainer* aContainer)
{
    using namespace std;
