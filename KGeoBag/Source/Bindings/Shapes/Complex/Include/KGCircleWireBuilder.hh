...
template<> inline bool KGCircleWireBuilder::AddAttribute(KContainer* anAttribute)
{
...
using KGCircleWireSurfaceBuilder = KComplexElement<KGWrappedSurface<KGCircleWire>>;

template<> inline bool KGCircleWireSurfaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGCircleWireSurfaceBuilder::AddElement(KContainer* anElement)
{
...
using KGCircleWireSpaceBuilder = KComplexElement<KGWrappedSpace<KGCircleWire>>;

template<> inline bool KGCircleWireSpaceBuilder::AddAttribute(KContainer* anAttribute)
{
    if (anAttribute->GetName() == "name") {
...
template<> inline bool KGCircleWireSpaceBuilder::AddElement(KContainer* anElement)
{
    if (anElement->GetName() == "circle_wire") {
        KGCircleWire* object = nullptr;
        anElement->ReleaseTo(object);
