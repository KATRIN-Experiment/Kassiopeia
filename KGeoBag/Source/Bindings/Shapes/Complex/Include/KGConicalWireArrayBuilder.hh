...
template<> inline bool KGConicalWireArrayBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGConicalWireArraySurfaceBuilder::AddElement(KContainer* anElement)
{
...
template<> inline bool KGConicalWireArraySpaceBuilder::AddElement(KContainer* anElement)
{
    if (anElement->GetName() == "conical_wire_array") {
        KGConicalWireArray* object = nullptr;
        anElement->ReleaseTo(object);
