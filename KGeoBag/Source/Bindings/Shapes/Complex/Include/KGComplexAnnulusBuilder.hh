...
template<> inline bool KGComplexAnnulusRingBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGComplexAnnulusBuilder::AddElement(KContainer* anElement)
{
...
template<> inline bool KGComplexAnnulusSurfaceBuilder::AddElement(KContainer* anElement)
{
