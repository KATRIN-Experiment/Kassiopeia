...
STATICINT sKGRodBuilderStructure =
    KGRodBuilder::Attribute<std::string>("name") + KGRodBuilder::Attribute<double>("radius") +
    KGRodBuilder::Attribute<int>("longitudinal_mesh_count") + KGRodBuilder::Attribute<int>("axial_mesh_count") +
    KGRodBuilder::ComplexElement<KGRodVertex>("vertex");

STATICINT sKGRodSurfaceBuilderStructure =
    KGRodSurfaceBuilder::Attribute<std::string>("name") + KGRodSurfaceBuilder::ComplexElement<KGRod>("rod");
...
STATICINT sKGRodSpaceBuilderStructure =
    KGRodSpaceBuilder::Attribute<std::string>("name") + KGRodSpaceBuilder::ComplexElement<KGRod>("rod");
