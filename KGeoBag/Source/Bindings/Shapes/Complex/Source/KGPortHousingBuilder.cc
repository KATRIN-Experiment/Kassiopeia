...
STATICINT sKGPortHousingCircularPortBuilderStructure = KGPortHousingCircularPortBuilder::Attribute<double>("radius") +
...
STATICINT sKGPortHousingBuilderStructure =
    KGPortHousingBuilder::Attribute<double>("radius") + KGPortHousingBuilder::Attribute<double>("x1") +
    KGPortHousingBuilder::Attribute<double>("y1") + KGPortHousingBuilder::Attribute<double>("z1") +
    KGPortHousingBuilder::Attribute<double>("x2") + KGPortHousingBuilder::Attribute<double>("y2") +
    KGPortHousingBuilder::Attribute<double>("z2") + KGPortHousingBuilder::Attribute<int>("longitudinal_mesh_count") +
