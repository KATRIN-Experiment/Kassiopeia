...
STATICINT sKGRotatedObjectLineBuilderStructure =
    KGRotatedObjectLineBuilder::Attribute<double>("z1") + KGRotatedObjectLineBuilder::Attribute<double>("r1") +
    KGRotatedObjectLineBuilder::Attribute<double>("z2") + KGRotatedObjectLineBuilder::Attribute<double>("r2");

STATICINT sKGRotatedObjectArcBuilderStructure =
    KGRotatedObjectArcBuilder::Attribute<double>("z1") + KGRotatedObjectArcBuilder::Attribute<double>("r1") +
    KGRotatedObjectArcBuilder::Attribute<double>("z2") + KGRotatedObjectArcBuilder::Attribute<double>("r2") +
    KGRotatedObjectArcBuilder::Attribute<double>("radius") +
    KGRotatedObjectArcBuilder::Attribute<bool>("positive_orientation");

STATICINT sKGRotatedObjectBuilderStructure = KGRotatedObjectBuilder::Attribute<int>("longitudinal_mesh_count_start") +
