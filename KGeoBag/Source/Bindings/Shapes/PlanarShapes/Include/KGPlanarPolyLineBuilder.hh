...
template<> inline bool KGPlanarPolyLineStartPointArgumentsBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGPlanarPolyLineBuilder::AddElement(KContainer* anElement)
{
