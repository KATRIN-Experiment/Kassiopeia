...
template<> inline bool KGFlattenedCircleSurfaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGFlattenedCircleSurfaceBuilder::AddElement(KContainer* anElement)
{
