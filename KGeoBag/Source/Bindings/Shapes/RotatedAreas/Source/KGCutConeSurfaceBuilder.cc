...
STATICINT sKGCutConeSurfaceBuilder = KGInterfaceBuilder::ComplexElement<KGCutConeSurface>("cut_cone_surface");

STATICINT sKGCutConeSurfaceBuilderStructure =
    KGCutConeSurfaceBuilder::Attribute<std::string>("name") + KGCutConeSurfaceBuilder::Attribute<double>("z1") +
    KGCutConeSurfaceBuilder::Attribute<double>("r1") + KGCutConeSurfaceBuilder::Attribute<double>("z2") +
