...
template<> inline bool KGRotatedPolyLineSurfaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGRotatedPolyLineSurfaceBuilder::AddElement(KContainer* anElement)
{
