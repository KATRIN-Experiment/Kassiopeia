...
template<> inline bool KGExtrudedArcSegmentSurfaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGExtrudedArcSegmentSurfaceBuilder::AddElement(KContainer* anElement)
{
