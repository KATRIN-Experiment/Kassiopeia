...
template<> inline bool KGRotatedPolyLineSpaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGRotatedPolyLineSpaceBuilder::AddElement(KContainer* anElement)
{
