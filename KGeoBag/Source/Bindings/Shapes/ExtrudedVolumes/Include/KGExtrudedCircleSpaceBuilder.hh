...
template<> inline bool KGExtrudedCircleSpaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGExtrudedCircleSpaceBuilder::AddElement(KContainer* anElement)
{
