...
STATICINT sKGExtrudedCircleSpaceBuilderStructure =
    KGExtrudedCircleSpaceBuilder::Attribute<std::string>("name") +
    KGExtrudedCircleSpaceBuilder::Attribute<double>("zmin") + KGExtrudedCircleSpaceBuilder::Attribute<double>("zmax") +
