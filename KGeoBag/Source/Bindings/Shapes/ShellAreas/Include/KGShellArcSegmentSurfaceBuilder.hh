...
template<> inline bool KGShellArcSegmentSurfaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGShellArcSegmentSurfaceBuilder::AddElement(KContainer* anElement)
{
