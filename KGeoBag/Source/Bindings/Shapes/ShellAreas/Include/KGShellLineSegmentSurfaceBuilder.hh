...
template<> inline bool KGShellLineSegmentSurfaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGShellLineSegmentSurfaceBuilder::AddElement(KContainer* anElement)
{
