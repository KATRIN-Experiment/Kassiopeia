...
template<> inline bool KGShellPolyLoopSurfaceBuilder::AddAttribute(KContainer* anAttribute)
{
...
template<> inline bool KGShellPolyLoopSurfaceBuilder::AddElement(KContainer* anElement)
{
