...
template<typename ObjectType> class KGObjectContainer
{
  public:
    KGObjectContainer()
    {
...
template<typename ObjectType> inline ObjectType* KGObjectContainer<ObjectType>::operator[](unsigned int i)
{
    return GetObjectWithID(i);  //fObjectVector[i];
}

template<typename ObjectType> inline const ObjectType* KGObjectContainer<ObjectType>::operator[](unsigned int i) const
{
    return GetObjectWithID(i);  //fObjectVector[i];
}
