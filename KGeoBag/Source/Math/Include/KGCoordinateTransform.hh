...
namespace KGeoBag
{
  ...
  public:
    ...
    KGCoordinateTransform(const double *p,
			  const double *x,
			  const double *y,
			  const double *z);
    ...
    void ConvertToLocalCoords(const double *global,
			      double *local,
			      const bool isVec) const;
    void ConvertToGlobalCoords(const double *local,
			       double *global,
			       const bool isVec) const;

    void ConvertToLocalCoords(const KThreeVector global,
			      KThreeVector& local,
			      const bool isVec) const;
    void ConvertToGlobalCoords(const KThreeVector local,
			       KThreeVector& global,
			       const bool isVec) const;
