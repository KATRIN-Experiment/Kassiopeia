...
double
KGInfinitePlane::NearestDistance(const KThreeVector& origin, const KThreeVector& unit_normal, const KThreeVector& aPoint)
{
    return fabs( unit_normal.Dot( aPoint - origin ) );
}

KThreeVector
KGInfinitePlane::NearestPoint(const KThreeVector& origin, const KThreeVector& unit_normal, const KThreeVector& aPoint)
{
...
bool
KGInfinitePlane::NearestIntersection(const KThreeVector& origin, const KThreeVector& unit_normal, const KThreeVector& aStart, const KThreeVector& anEnd, KThreeVector& anIntersection, double& distance)
{
    KThreeVector v = (anEnd - aStart).Unit();
    double len = v.Magnitude();
