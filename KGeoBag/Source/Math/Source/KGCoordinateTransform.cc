...
namespace KGeoBag
{
  ...
  KGCoordinateTransform::KGCoordinateTransform(const double *p,
					       const double *x,
					       const double *y,
					       const double *z)
  {
  ...
  void KGCoordinateTransform::ConvertToLocalCoords(const double *global,
						   double *local,
  ...
  void KGCoordinateTransform::ConvertToGlobalCoords(const double *local,
						    double *global,
						    const bool isVec) const
  {
    /**
...
//	  std::cout << "isVec: " << isVec << std::endl;
  ...
  void KGCoordinateTransform::ConvertToGlobalCoords(const KThreeVector local,
						    KThreeVector& global,
						    const bool isVec) const
  {
    /**
