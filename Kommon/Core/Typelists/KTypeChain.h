...
namespace katrin
{
    ...
    template< template< class > class XContainer, class XTypeList >
    class KSingleChain;
        ...
        public KSingleChain< XContainer, XNextType >
    {
        public:
            KSingleChain() :
                XContainer< XType >(),
                KSingleChain< XContainer, XNextType >()
            {
            }
    ...
    template< template< class > class XContainer >
    class KSingleChain< XContainer, KTypeNull >
    {
        public:
            KSingleChain()
            {
    ...
    template< template< class, class > class XContainer, class XParameter, class XTypeList >
    class KSingleChainSingleParameter;
    ...
    template< template< class, class > class XContainer, class XParameter, class XTypeList >
    class KSingleChainDoubleParameter;
