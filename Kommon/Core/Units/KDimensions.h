...
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KDimensionless;

//base dimensions
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KMassDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<1>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KLengthDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<1>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KTimeDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KChargeDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<1>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KTemperatureDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<1>, KTypeInteger<0>)>
    KIntensityDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<1>)>
    KAngleDimension;

//derived mechanical dimensions
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<2>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KAreaDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<3>, KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KVolumeDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<-1>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
...
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<-1>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<1>)>
    KAngularFrequencyDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<1>, KTypeInteger<-1>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KVelocityDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<1>, KTypeInteger<-2>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KAccelerationDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<1>, KTypeInteger<-1>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KMomentumDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<1>, KTypeInteger<-2>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KForceDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<-1>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<-1>)>
    KAngularMomentumDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<-2>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<-1>)>
    KTorqueDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<-2>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KEnergyDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<-3>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KPowerDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<-1>, KTypeInteger<-2>, KTypeInteger<0>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
...
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<-2>, KTypeInteger<-1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KElectricPotentialDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<1>, KTypeInteger<-2>, KTypeInteger<-1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KElectricFieldDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<1>, KTypeInteger<-1>, KTypeInteger<-1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KMagneticPotentialDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<0>, KTypeInteger<-1>, KTypeInteger<-1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KMagneticFieldDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<-1>, KTypeInteger<-3>, KTypeInteger<2>, KTypeInteger<2>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KElectricPermittivityDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<1>, KTypeInteger<0>, KTypeInteger<-2>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KMagneticPermeabilityDimension;

typedef KDimension<KTYPELIST7(KTypeInteger<0>, KTypeInteger<0>, KTypeInteger<-1>, KTypeInteger<1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KCurrentDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<-1>, KTypeInteger<2>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KResistanceDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<0>, KTypeInteger<-1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KInductanceDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<-1>, KTypeInteger<-2>, KTypeInteger<2>, KTypeInteger<2>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KCapacitanceDimension;
typedef KDimension<KTYPELIST7(KTypeInteger<1>, KTypeInteger<2>, KTypeInteger<-1>, KTypeInteger<-1>, KTypeInteger<0>,
                              KTypeInteger<0>, KTypeInteger<0>)>
    KMagneticFluxDimension;
