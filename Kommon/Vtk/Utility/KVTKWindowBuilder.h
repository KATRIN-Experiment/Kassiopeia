...
template<> inline bool KVTKWindowBuilder::Begin()
{
    fObject = new KVTKWindow();
    return true;
}

template<> inline bool KVTKWindowBuilder::AddAttribute(KContainer* aContainer)
{
...
template<> inline bool KVTKWindowBuilder::AddElement(KContainer* aContainer)
{
...
template<> inline bool KVTKWindowBuilder::End()
{
    fObject->Render();
    fObject->Write();
    fObject->Display();
