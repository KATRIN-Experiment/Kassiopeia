...
STATICINT sKVTKWindow = KRootBuilder::ComplexElement<KVTKWindow>("vtk_window");
...
STATICINT sKVTKWindowStructure =
    ...
    KVTKWindowBuilder::Attribute<double>("view_angle") + KVTKWindowBuilder::Attribute<unsigned int>("multi_samples") +
